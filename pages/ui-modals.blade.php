                    ...
                    <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="button-group">
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="scroll-long-outer-modal"
                                        ...
                                        <!-- Modal -->
                                        <div class="modal fade" id="scroll-long-inner-modal"
                                            data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                                        ...
                                        <!-- Button trigger modal -->
                                        <button type="button"
                                            class="btn mb-1 bg-danger-subtle text-danger px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#with-grid-modal">
                                            With Grid Modal
                                        </button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="with-grid-modal" tabindex="-1"
                                            aria-labelledby="scroll-long-inner-modal" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-scrollable">
                                                <div class="modal-content">
                                                    <div class="modal-header d-flex align-items-center">
                                                    ...
                                                    <div class="modal-body">
                                                        <div class="container-fluid">
                                                            ...
                                                            <div class="row border mt-3">
                                                                <div
                                                                    class="col-md-3 ms-auto bg-light border-end py-3">
                                                                    .col-md-3 .ms-auto
                                                                </div>
                        ...
                        <div class="col-md-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Varying Modal content</h5>
                                    </div>
                                    <!-- sample modal content -->
                                    <div class="button-group">
                                        <button type="button"
                                            class="btn mb-1 px-4 fs-4  bg-primary-subtle text-primary"
                                        ...
                                        <button type="button"
                                            class="btn mb-1 px-4 fs-4  bg-success-subtle text-success"
                                            data-bs-toggle="modal" data-bs-target="#samedata-modal"
                                        ...
                                        <button type="button"
                                            class="btn mb-1 px-4 fs-4  bg-warning-subtle text-warning"
                                            data-bs-toggle="modal" data-bs-target="#samedata-modal"
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <div class="button-group">
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <div class="text-center mt-2 mb-4">
                                                            <a href="/" class="text-success">
                                                                <span><img src="../assets/images/logos/favicon.png"
                                                                        class="me-3" width="40"
                                                                        alt="">
                                                                </span>
                                                            </a>
                                                        ...
                                                        <form action="#" class="ps-3 pr-3">
                                                            ...
                                                            <div class="mb-3 text-center">
                                                                <button
                                                                    class="btn btn-rounded bg-info-subtle text-info "
                                                                    type="submit">
                                                                    Sign In
                                                                </button>
                                                            </div>
                                        ...
                                        <!-- /.modal -->
                                        <!-- Full width modal -->
                                        <button type="button" class="btn bg-warning-subtle text-warning px-4 fs-4 "
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="button-group">
                                        ...
                                        <!-- Fullscreen -->
                                        <!-- ------------------------------------------ -->
                                        <button class="btn mb-1 bg-primary-subtle text-primary px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#bs-fullscreen">
                                            Fullscreen Modal
                                        </button>
                                        <div class="modal fade" id="bs-fullscreen" tabindex="-1"
                                            aria-labelledby="bs-example-modal-lg" aria-hidden="true">
                                        ...
                                        <!-- Fullscreen -->
                                        <!-- ------------------------------------------ -->
                                        <button class="btn mb-1 bg-success-subtle text-success px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#bs-fullscreen-down-sm">
                                        ...
                                        <!-- Fullscreen -->
                                        <!-- ------------------------------------------ -->
                                        <button class="btn mb-1 bg-warning-subtle text-warning px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#bs-fullscreen-down-md">
                                        ...
                                        <!-- Fullscreen -->
                                        <!-- ------------------------------------------ -->
                                        <button class="btn mb-1 bg-danger-subtle text-danger px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#bs-fullscreen-down-lg">
                                        ...
                                        <!-- ------------------------------------------ -->
                                        <button class="btn mb-1 bg-success-subtle text-success px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#bs-fullscreen-down-xl">
                                        ...
                                        <!-- ------------------------------------------ -->
                                        <button class="btn mb-1 bg-danger-subtle text-danger px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#bs-fullscreen-down-xxl">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Modal Header Coloured</h5>
                                    </div>
                                    <div class="button-group">
                                        ...
                                        <!-- /.modal -->
                                        <!-- info header modal -->
                                        <button type="button" class="btn mb-1 bg-info-subtle text-info px-4 fs-4 "
                                        ...
                                        <div id="danger-header-modal" class="modal fade" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                <div class="modal-content">
                                                    <div
                                                        class="modal-header modal-colored-header bg-danger text-white">
                                                        <h4 class="modal-title text-white"
                                        ...
                                        <div id="warning-header-modal" class="modal fade" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                <div class="modal-content">
                                                    <div
                                                        class="modal-header modal-colored-header bg-warning text-white">
                                                        <h4 class="modal-title text-white"
                                        ...
                                        <div id="success-header-modal" class="modal fade" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                <div class="modal-content">
                                                    <div
                                                        class="modal-header modal-colored-header bg-success text-white">
                                                        <h4 class="modal-title text-white"
                                        ...
                                        <!-- /.modal -->
                                        <!-- dark header modal -->
                                        <button type="button" class="btn mb-1 btn-dark px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#dark-header-modal">
                                            Dark Header
                                        </button>
                                        <!-- dark Header Modal -->
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Modal Filled Coloured</h5>
                                    </div>
                                    <div class="button-group">
                                        <!-- Primary header modal -->
                                        <button type="button"
                                        ...
                                        <!-- info header modal -->
                                        <button type="button" class="btn mb-1 bg-info-subtle text-info px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#bg-info-header-modal">
                                            Info Modal
                                        </button>
                                        <!-- info Header Modal -->
                                        <div id="bg-info-header-modal" class="modal fade" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                <div class="modal-content modal-filled bg-info">
                                                    <div class="modal-header modal-colored-header text-white">
                                                        <h4 class="modal-title text-white id="
                                                            info-header-modallabel"="">
                                                            Modal Heading
                                                        </h4>
                                                        <button type="button" class="btn-close btn-close-white"
                                                            data-bs-dismiss="modal" aria-label="Close"></button>
                                        ...
                                        <!-- dark header modal -->
                                        <button type="button" class="btn mb-1 btn-dark px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#bg-dark-header-modal">
                                            Dark Modal
                                        </button>
                                        <!-- dark Header Modal -->
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Modal Based Alerts</h5>
                                    </div>
                                    <div class="button-group">
                                        <!-- Button trigger modal -->
                                        <button type="button"
                                        ...
                                        <div class="modal fade" id="al-success-alert" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-sm">
                                                <div
                                                    class="modal-content modal-filled bg-success-subtle text-success">
                                        ...
                                        <!-- Button trigger modal -->
                                        <button type="button" class="btn mb-1 bg-info-subtle text-info  px-4 fs-4 "
                                            data-bs-toggle="modal" data-bs-target="#al-info-alert">
                                            Info Alert
                                        </button>

                                        <!-- Vertically centered modal -->
                                        <div class="modal fade" id="al-info-alert" tabindex="-1"
                                            aria-labelledby="vertical-center-modal" aria-hidden="true">
                                            <div class="modal-dialog modal-sm">
