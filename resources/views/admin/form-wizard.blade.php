                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Form Wizard</h4>
                                    ...
                                    <form action="#" class="tab-wizard wizard-circle">
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="firstName1">First Name
                                                            :</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="lastName1">Last Name
                                                            :</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="emailAddress1">Email Address
                                                            :</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="phoneNumber1">Phone Number
                                                            :</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="location1">Select City
                                                            :</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="date1">Date of Birth
                                                            :</label>
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="jobTitle1">Job Title
                                                            :</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="videoUrl1">Company Name
                                                            :</label>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="shortDescription1">Job
                                                            Description :</label>
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="int1">Interview For
                                                            :</label>
                                                        <input type="text" class="form-control" id="int1">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="intType1">Interview Type
                                                            :</label>
                                                        <select class="form-select" id="intType1"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="jobTitle2">Interview Date
                                                            :</label>
                                                        <input type="date" class="form-control" id="jobTitle2">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="customRadio6" class="form-label">Requirements
                                                            :</label>
                                                        <div class="c-inputs-stacked">
                                                            <div class="form-check">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="customRadio6">Employee</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio7"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio7">Contract</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            for="participants1">Confidance</label>
                                                        <input type="text" class="form-control"
                                                            id="participants1">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="participants2">Result</label>
                                                        <select class="form-select" id="participants2"
                                                            name="location">
                                                            <option value="">Select Result</option>
                                                            <option value="Selected">Selected</option>
                                                            <option value="Rejected">Rejected</option>
                                                            <option value="Call Second-time"> Call Second-time
                                                            </option>
                                                        </select>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="customRadio1" class="form-label">Rate Interviwer
                                                            :</label>
                                                        <div class="c-inputs-stacked">
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio1"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label" for="customRadio1">1
                                                                    star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio2"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label" for="customRadio2">2
                                                                    star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio3"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label" for="customRadio3">3
                                                                    star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio4"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label" for="customRadio4">4
                                                                    star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio5"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label" for="customRadio5">5
                                                                    star</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                    ...
                                    <form action="#" class="validation-wizard wizard-circle mt-5">
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wfirstName2"> First Name :
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wlastName2"> Last Name :
                                                            <span class="danger">*</span>
                                                        </label>
                                                        <input type="text" class="form-control required"
                                                            id="wlastName2" name="lastName">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wemailAddress2"> Email
                                                            Address : <span class="danger">*</span>
                                                        </label>
                                                        <input type="email" class="form-control required"
                                                            id="wemailAddress2" name="emailAddress">
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wphoneNumber2">Phone Number
                                                            :</label>
                                                        <input type="tel" class="form-control"
                                                            id="wphoneNumber2">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wlocation2"> Select City :
                                                            <span class="danger">*</span>
                                                        </label>
                                                        <select class="form-select required" id="wlocation2"
                                                            name="location">
                                                            <option value="">Select City</option>
                                                            <option value="India">India</option>
                                                            <option value="USA">USA</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wdate2">Date of Birth
                                                            :</label>
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="jobTitle3">Company Name
                                                            :</label>
                                                        <input type="text" class="form-control required"
                                                            id="jobTitle3">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="webUrl3">Company URL
                                                            :</label>
                                                        <input type="url" class="form-control required"
                                                            id="webUrl3" name="webUrl3">
                                                    </div>
                                                </div>
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="shortDescription3">Short
                                                            Description :</label>
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wint1">Interview For
                                                            :</label>
                                                        <input type="text" class="form-control required"
                                                            id="wint1">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wintType1">Interview Type
                                                            :</label>
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wLocation1">Location
                                                            :</label>
                                                        <select class="form-select required" id="wLocation1"
                                                            name="wlocation">
                                                            <option value="">Select City</option>
                                                            <option value="India">India</option>
                                                            <option value="USA">USA</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="wjobTitle2">Interview Date
                                                            :</label>
                                                        <input type="date" class="form-control required"
                                                            id="wjobTitle2">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="customRadio16" class="form-label">Requirements
                                                            :</label>
                                                        <div class="c-inputs-stacked">
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio16"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio16">Employee</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio17"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio17">Contract</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            for="participants3">Confidance</label>
                                                        <input type="text" class="form-control required"
                                                            id="participants3">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="participants4">Result</label>
                                                        <select class="form-select required" id="participants4"
                                                            name="location">
                                                            <option value="">Select Result</option>
                                                            <option value="Selected">Selected</option>
                                                            <option value="Rejected">Rejected</option>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="customRadio11" class="form-label">Rate
                                                            Interviwer :</label>
                                                        <div class="c-inputs-stacked">
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio11"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio11">1 star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio12"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio12">2 star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio13"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio13">3 star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio14"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio14">4 star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio15"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio15">5 star</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <form action="#" class="tab-wizard vertical wizard-circle mt-5">
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="firstName2">First Name
                                                            :</label>
                                                        <input type="text" class="form-control"
                                                            id="firstName2">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="lastName2">Last Name
                                                            :</label>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="emailAddress2">Email Address
                                                            :</label>
                                                        <input type="email" class="form-control"
                                                            id="emailAddress2">
                                                    </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="phoneNumber2">Phone Number
                                                            :</label>
                                                        <input type="tel" class="form-control"
                                                            id="phoneNumber2">
                                                    </div>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="location3">Select City
                                                            :</label>
                                                        <select class="form-select" id="location3"
                                                            name="location">
                                                            <option value="">Select City</option>
                                                            <option value="Amsterdam">India</option>
                                                            <option value="Berlin">USA</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="date2">Date of Birth
                                                            :</label>
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="jobTitle5">Job Title
                                                            :</label>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="videoUrl2">Company Name
                                                            :</label>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="shortDescription2">Job
                                                            Description :</label>
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="int2">Interview For
                                                            :</label>
                                                        <input type="text" class="form-control" id="int2">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="intType2">Interview Type
                                                            :</label>
                                                        <select class="form-select" id="intType2"
                                                            data-placeholder="Type to search cities"
                                                            name="intType2">
                                                            <option value="Banquet">Normal</option>
                                                            <option value="Fund Raiser">Difficult</option>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        <label class="form-label" for="jobTitle4">Interview Date
                                                            :</label>
                                                        <input type="date" class="form-control" id="jobTitle4">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label for="customRadio26" class="form-label">Requirements
                                                            :</label>
                                                        <div class="c-inputs-stacked">
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio26"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio26">Employee</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio27"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio27">Contract</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <section>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        <label class="form-label"
                                                            for="participants5">Confidance</label>
                                                        <input type="text" class="form-control"
                                                            id="participants5">
                                                    </div>
                                                    <div class="mb-3">
                                                        <label class="form-label" for="participants6">Result</label>
                                                        <select class="form-select" id="participants6"
                                                            name="location">
                                                            <option value="">Select Result</option>
                                                            <option value="Selected">Selected</option>
                                                            <option value="Rejected">Rejected</option>
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="customRadio21" class="form-label">Rate
                                                            Interviwer :</label>
                                                        <div class="c-inputs-stacked">
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio21"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio21">1 star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio22"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio22">2 star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio23"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio23">3 star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio24"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio24">4 star</label>
                                                            </div>
                                                            <div class="form-check">
                                                                <input type="radio" id="customRadio25"
                                                                    name="customRadio" class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="customRadio25">5 star</label>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div>
                                            ...
                                            <section>
                                                ...
                                                <input id="password" name="password" type="password"
                                                    class="required form-control mb-3"
                                            ...
                                            <section>
                                                ...
                                                <input id="email" name="email" type="text"
                                                    class="required email form-control mb-3" autocomplete="on">
                                                <label class="form-label" for="address">Address</label>
                                                <input id="address" name="address" type="text"
                                                    class="form-control mb-3" autocomplete="on">
                                                <p>(*) Mandatory</p>
                                            </section>
                                            <h3>Hints</h3>
                                            <section>
                                            ...
                                            <section>
                                                <input id="acceptTerms" name="acceptTerms" type="checkbox"
                                                    class="required">
                                                <label for="acceptTerms">I agree with the Terms and
                                                    Conditions.</label>
                                            </section>
                                        </div>
                                    </form>
                                    ...
                                    <form id="example-advanced-form" action="#" class="mt-5">
                                        ...
                                        <fieldset>
                                            ...
                                            <input id="password-2" name="password" type="password"
                                                class="required form-control mb-3" autocomplete="current-password">
                                        ...
                                        <fieldset>
                                            ...
                                            <input id="address-2" name="address" type="text"
                                                class="form-control mb-3" autocomplete="on">
                                            <label class="form-label" for="age-2">Age (The warning step will show
                                                up if age is less than 18)
                                                *</label>
                                            <input id="age-2" name="age" type="text"
                                                class="required number form-control mb-3">
                                            <p>(*) Mandatory</p>
                                        </fieldset>
                                        <h3>Warning</h3>
                                        <fieldset>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div id="example-manipulation" class="mt-5">
                                        ...
                                        <section>
                                            <p>
                                                <label class="form-label" for="position-3">Position (zero-based)
                                                    *</label>
                                                <br>
                                        ...
                                        <section>
                                            <p>
                                                <label class="form-label" for="position2-3">Position (zero-based)
                                                    *</label>
                                                <br>
