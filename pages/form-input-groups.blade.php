...
<body>
    ...
    <a href="javascript:void(0)" class="sidebartoggler ms-auto text-decoration-none fs-5 d-block d-xl-none">
      ...
      &lt;/form&gt;
                                    ...
                                    <form>
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control"
                                                aria-label="Text input with checkbox">
                                            <button class="btn bg-primary-subtle text-primary rounded-end "
                                                type="button">
                                                Go!
                                            </button>
                                        </div>
      ...
      &lt;/form&gt;
                                    ...
                                    <form>
                                        <div class="input-group">
                                            <button class="btn bg-primary-subtle text-primary rounded-start "
                                                type="button">
                                                Go!
                                            </button>
                                            <input type="text" class="form-control"
                        ...
                        <div class="col-md-6 col-lg-4 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="d-flex mb-3 align-items-center">
                                        <div>
                                            <h5 class="mb-0 fs-5">Addons With Right Radio</h5>
                                        </div>
                                        <div class="ms-auto flex-shrink-0">
                                            <button
                                                class="btn bg-primary-subtle text-primary rounded-pill text-decoration-none btn-sm"
      ...
      &lt;/form&gt;
                                    ...
                                    <form class="mt-3">
                                        <div class="input-group mb-3">
                                            <button
                                                class="btn bg-danger-subtle text-danger  rounded-start d-flex align-items-center"
                                                type="button">
                                            ...
                                            <input type="text" class="form-control" placeholder=""
                                                aria-label="" aria-describedby="basic-addon1">
                                            <button
                                                class="btn bg-info-subtle text-info  rounded-end d-flex align-items-center"
                                                type="button">
      ...
      &lt;/form&gt;
                                    ...
                                    <form class="mt-3">
                                        <div class="input-group mb-3">
                                            <div>
                                                <button
                                                    class="btn bg-primary-subtle text-primary rounded-start rounded-end-0"
                                                    type="button">
      ...
      &lt;/form&gt;
                                    ...
                                    <form class="mt-3">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder=""
                                                aria-label="" aria-describedby="basic-addon1">
                                            <button class="btn bg-danger-subtle text-danger rounded-end"
                                                type="button">
      ...
      &lt;/form&gt;
                                    ...
                                    <form class="mt-3">
                                        <div class="input-group">
                                            <button
                                                class="btn bg-primary-subtle text-primary  dropdown-toggle rounded-start"
                                    ...
                                    <form class="mt-3">
                                        <div class="input-group">
                                            <input type="text" class="form-control"
                                                aria-label="Text input with dropdown button">
                                            <button
                                                class="btn bg-primary-subtle text-primary rounded-end  dropdown-toggle"
                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Dropdown
                                            </button>
