                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="mb-3">Rounded Input Form</h5>
                                    <form>
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    ...
                                                    <input type="email" class="form-control rounded-pill"
                                                        id="tb-email" placeholder="name@example.com">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="tb-pwd">Password</label>
                                                    <input type="password" class="form-control rounded-pill"
                                                        id="tb-pwd" placeholder="Password">
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="mb-3">
                                                    <label class="form-label" for="tb-cpwd">Confirm
                                                        Password</label>
                                                    <input type="password" class="form-control rounded-pill"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form>
                                        <fieldset disabled="">
                                            <div class="mb-3">
                                                <label class="form-label" for="disabledTextInput1">Disabled
                                                    input</label>
                                                <input type="text" id="disabledTextInput1" class="form-control"
                                                    placeholder="Disabled input">
                                            </div>
                                            <div class="mb-3">
                                                <label class="form-label" for="disabledSelect">Disabled select
                                                    menu</label>
                                            ...
                                            <button type="submit" class="btn btn-muted rounded-pill px-4 mt-3">
                                                Submit
                                            </button>
                                        </fieldset>
                                    </form>
                                    ...
                                    <form>
                                        ...
                                        <div class="d-md-flex align-items-center">
                                            <div class="form-check mr-sm-2">
                                                <input type="checkbox" class="form-check-input" id="sf1"
                                                    value="check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="d-md-flex align-items-center">
                                            <div class="form-check mr-sm-2">
                                                <input type="checkbox" class="form-check-input" id="sf2"
                                                    value="check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control border border-warning"
                                                placeholder="Email">
                                            <label><i class="ti ti-mail me-2 fs-4 text-warning"></i><span
                                                    class="border-start border-warning ps-3">Email
                                                    address</span></label>
                                        </div>
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control border border-warning"
                                                placeholder="Password">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control border border-warning"
                                                placeholder="CPassword">
                                            <label><i class="ti ti-lock me-2 fs-4 text-warning"></i><span
                                                    class="border-start border-warning ps-3">Confirm
                                                    Password</span></label>
                                        </div>

                                        <div class="d-md-flex align-items-center">
                                            <div class="form-check mr-sm-2">
                                                <input type="checkbox" class="form-check-input" id="sf3"
                                                    value="check">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <label><i class="ti ti-mail me-2 fs-4 text-primary"></i><span
                                                    class="border-start border-primary ps-3">Email
                                                    address</span></label>
                                        </div>
                                        <div class="form-floating mb-3">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control border border-primary"
                                                placeholder="CPassword">
                                            <label><i class="ti ti-lock me-2 fs-4 text-primary"></i><span
                                                    class="border-start border-primary ps-3">Confirm
                                                    Password</span></label>
                                        </div>

                                        <div class="d-md-flex align-items-center">
                                            <div class="form-check mr-sm-2">
                                                <input type="checkbox" class="form-check-input" id="sf4"
                                                    value="check">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-floating mb-3">
                                            ...
                                            <label><i class="ti ti-mail me-2 fs-4 text-success"></i><span
                                                    class="border-start border-success ps-3">Email
                                                    address</span></label>
                                        </div>
                                        <div class="form-floating mb-3">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control border border-success"
                                                placeholder="CPassword">
                                            <label><i class="ti ti-lock me-2 fs-4 text-success"></i><span
                                                    class="border-start border-success ps-3">Confirm
                                                    Password</span></label>
                                        </div>

                                        <div class="d-md-flex align-items-center">
                                            <div class="form-check mr-sm-2">
                                                <input type="checkbox" class="form-check-input" id="sf5"
                                                    value="check">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <form>
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="email" class="form-control border border-danger"
                                                placeholder="Email">
                                            <label><i class="ti ti-mail me-2 fs-4 text-danger"></i><span
                                                    class="border-start border-danger ps-3">Email
                                                    address</span></label>
                                        </div>
                                        <div class="form-floating mb-3">
                                        ...
                                        <div class="form-floating mb-3">
                                            <input type="password" class="form-control border border-danger"
                                                placeholder="CPassword">
                                            <label><i class="ti ti-lock me-2 fs-4 text-danger"></i><span
                                                    class="border-start border-danger ps-3">Confirm
                                                    Password</span></label>
                                        </div>

                                        <div class="d-md-flex align-items-center">
                                            <div class="form-check mr-sm-2">
                                                <input type="checkbox" class="form-check-input" id="sf6"
                                                    value="check">
                                        ...
                                        <div class="col-sm-4">
                                            ...
                                            <div class="custom-control py-2 custom-radio">
                                                <input type="radio" id="customRadio2" name="customRadio"
                                                    class="form-check-input">
                                                <label class="form-check-label" for="customRadio2">Toggle this
                                                    custom radio</label>
                                            </div>
                                        </div>
                                        <div class="col-sm-4">
                                    ...
                                    <form class="form">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="search"
                                                    value="How do I shoot web" id="example-search-input">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-url-input"
                                                class="col-md-2 col-form-label">URL</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-md-10">
                                                <input class="form-control" type="tel"
                                                    value="1-(555)-555-5555" id="example-tel-input">
                                            </div>
                                        </div>
                                        <div class="mb-3 row">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-number-input"
                                                class="col-md-2 col-form-label">Number</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-datetime-local-input"
                                                class="col-md-2 col-form-label">Date and time</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-week-input"
                                                class="col-md-2 col-form-label">Week</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-time-input"
                                                class="col-md-2 col-form-label">Time</label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="mb-3 row">
                                            <label for="example-month-input2"
                                                class="col-md-2 col-form-label">Select</label>
                                            <div class="col-md-10">
                                    ...
                                    <div class="col-sm-12 col-xs-12">
                                        <form class="input-form">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="input-group mb-3">
                                                        <button class="btn btn-primary rounded-start"
                                                            type="button">
                                                            Go!
                                                        </button>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <div class="input-group mb-3">
                                                        <button
                                                            class="btn bg-danger-subtle  rounded-start text-danger"
                                                            type="button">
                                                            <div class="d-flex align-items-center">
                                        ...
                                        <form class="input-form">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="input-group mb-3">
                                                        <button
                                                            class="btn bg-primary-subtle text-primary rounded-start dropdown-toggle"
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="input-group mb-3">
                                                        ...
                                                        <div>
                                                            <button
                                                                class="btn bg-primary-subtle text-primary rounded-end rounded-start-0 dropdown-toggle"
                                                                type="button" data-bs-toggle="dropdown"
                                                                aria-haspopup="true" aria-expanded="false">
                                                                Dropdown
                                                            </button>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <form class="form-horizontal row">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label class="form-label" for="inputSuccess1">Input with
                                                        success</label>
                                                ...
                                                <div class="mb-3">
                                                    <label class="form-label" for="inputDanger1">Input with
                                                        danger</label>
                                        ...
                                        <form class="form-horizontal">
                                            <div class="mb-3 row">
                                                <label for="inputHorizontalSuccess"
                                                    class="col-sm-2 form-label">Email</label>
                                                <div class="col-sm-10">
