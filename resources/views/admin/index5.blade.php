                            ...
                            <div class="d-flex align-items-center gap-4 mb-4">
                                <div class="position-relative">
                                    <div class="border border-2 border-primary rounded-circle">
                                        <img src="../assets/images/profile/user-1.jpg" class="rounded-circle m-1"
                                            alt="user1" width="60">
                                    </div>
                                    <span
                                                ...
                                                <div class="d-md-flex align-items-start gap-3">
                                                    <div>
                                                        ...
                                                        <div class="d-flex align-items-center gap-3">
                                                            ...
                                                            <span
                                                                class="badge text-bg-primary  px-2 py-1 d-flex align-items-center">
                                            ...
                                            <div class="p-4 py-3 py-md-4">
                                                <p class="fs-4 text-danger mb-0">
                                                    <span class="text-danger">
                                                        <span
                                                            class="round-8 text-bg-danger rounded-circle d-inline-block me-1"></span>
                                            ...
                                            <div class="p-4 py-3 py-md-4">
                                                <p class="fs-4 text-primary mb-0">
                                                    <span class="text-primary">
                                                        <span
                                                            class="round-8 text-bg-primary rounded-circle d-inline-block me-1"></span>
                                                    </span>Followers
                                                </p>
                                            ...
                                            <div class="p-4 py-3 py-md-4">
                                                <p class="fs-4 text-info mb-0">
                                                    <span class="text-info">
                                                        <span
                                                            class="round-8 text-bg-info rounded-circle d-inline-block me-1"></span>
                                                    </span>Campaign
                                                </p>
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div>
                                            ...
                                            <div class="d-flex gap-2">
                                                <span>
                                                    <span
                                                        class="round-8 text-bg-primary rounded-circle d-inline-block"></span>
                                                </span>
                                    ...
                                    <div class="d-md-flex align-items-center mb-9">
                                        ...
                                        <div class="ms-auto mt-4 mt-md-0">
                                            <ul class="nav nav-tabs" role="tablist">
                                                <li class="nav-item">
                                                    <a class="nav-link rounded active" data-bs-toggle="tab"
                                                        href="#home" role="tab">
                                                        <span>Checkout</span>
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a class="nav-link rounded" data-bs-toggle="tab"
                                        ...
                                        <div class="ms-auto mt-4 mt-md-0">
                                            <div class="hstack">
                                                <a href="javascript:void(0)" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="John Deo">
                                                    <img src="../assets/images/profile/user-2.jpg"
                                                        class="rounded-circle border border-2 border-white"
                                                        width="35" alt="u1">
                                                </a>
                                                <a href="javascript:void(0)" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Mark Smith" class="ms-n2">
                                                    <img src="../assets/images/profile/user-3.jpg"
                                                        class="rounded-circle border border-2 border-white"
                                                        width="35" alt="u2">
                                                </a>
                                                <a href="javascript:void(0)" data-bs-toggle="tooltip"
                                                    data-bs-placement="top" title="Jonthan Leo" class="ms-n2">
                                ...
                                <div class="p-3">
                                    <div class="hstack gap-3 justify-content-center">
                                        <div>
                                            <span>
                                                <span
                                                    class="round-8 text-bg-primary rounded-circle d-inline-block me-2"></span>
                                            </span>
                                        ...
                                        <div>
                                            <span>
                                                <span
                                                    class="round-8 text-bg-danger rounded-circle d-inline-block me-2"></span>
                                            </span>
