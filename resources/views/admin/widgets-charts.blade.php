                ...
                <div class="container-fluid">
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Charts</h4>
                            ...
                            <div class="card w-100 position-relative overflow-hidden">
                                <div class="card-body">
                                    <div class="d-flex align-items-end justify-content-between">
                                        <div>
                                            <h4 class="mb-0 fw-semibold">2,545</h4>
                            ...
                            <div class="card w-100 position-relative overflow-hidden">
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-end justify-content-between mb-3">
                                        <div>
                                            <h4 class="mb-0 fw-semibold">15,480</h4>
                            ...
                            <div class="card w-100 position-relative overflow-hidden">
                                <div class="card-body p-4">
                                    <div class="mb-7 pb-8">
                                        ...
                                        <h4 class="mb-0 fw-semibold">$78,298</h4>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body p-4">
                            <div class="d-flex align-items-center justify-content-between mb-4 pb-8">
                                <h5 class="card-title fw-semibold mb-0">Current Value</h5>
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            ...
                            <div class="card w-100 position-relative overflow-hidden">
                                <div class="card-body pb-4">
                                    <div class="d-flex align-items-center justify-content-between mb-4">
                                        <h5 class="card-title mb-0 fw-semibold"> Monthly Earnings </h5>
                                        <div class="p-2 bg-primary-subtle rounded-2 d-inline-block">
                                            <img src="../assets/images/svgs/icon-master-card-2.svg" alt=""
                            ...
                            <div class="card w-100 position-relative overflow-hidden">
                                <div class="card-body">
                                    ...
                                    <div id="most-visited" class="rounded-bars"></div>
                        ...
                        <div class="col-lg-4">
                                ...
                                <div class="card-body">
                                    <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mt-3">
                                            <div class="d-flex align-items-center">
                                                <div
                                                    class="bg-primary-subtle rounded-2 me-8 p-8 d-flex align-items-center justify-content-center">
                                            ...
                                            <div class="d-flex align-items-center">
                                                <div
                                                    class="text-bg-light rounded-2 me-8 p-8 d-flex align-items-center justify-content-center">
                            ...
                            <div class="card w-100 position-relative overflow-hidden">
                                <div class="card-body">
                                    <h5 class="card-title fw-semibold mb-0">Page Impressions</h5>
                                    <div class="row align-items-center">
                                        <div class="col-md-6">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-5 pb-2">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="bg-secondary-subtle rounded-2 me-8 p-8 d-flex align-items-center justify-content-center">
