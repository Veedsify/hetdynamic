                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Accordian Flush</h5>
                                    </div>
                        ...
                        <div class="col-lg-5 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Collapse</h5>
                                    </div>
                                    <p class="button-group">
                                        <a class="btn bg-info-subtle mb-2  text-info px-4 rounded-pill"
                                            data-bs-toggle="collapse" href="#collapseExample" role="button"
                                            aria-expanded="false" aria-controls="collapseExample">
                                            Link with href
                                        </a>
                                        <button class="btn bg-warning-subtle  text-warning px-4 rounded-pill"
                        ...
                        <div class="col-lg-7 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Collapse with multiple targets</h5>
                                    </div>
                                    <div class="button-group">
                                        <a class="btn bg-primary-subtle mb-2 text-primary px-4 rounded-pill "
                                            data-bs-toggle="collapse" href="#multiCollapseExample1" role="button"
                                            aria-expanded="false" aria-controls="multiCollapseExample1">Toggle 1st
                                            obejct</a>
                                        <button class="btn bg-success-subtle mb-2 text-success px-4 rounded-pill "
                                            type="button" data-bs-toggle="collapse"
                                            data-bs-target="#multiCollapseExample2" aria-expanded="false"
                                            aria-controls="multiCollapseExample2">
                                            Toggle 2nd obejct
                                        </button>
                                        <button class="btn bg-danger-subtle mb-2 text-danger px-4 rounded-pill "
                                            type="button" data-bs-toggle="collapse"
