                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Offcanvas</h4>
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex gap-6 flex-wrap">
                                        <a class="btn bg-primary-subtle text-primary" data-bs-toggle="offcanvas"
                                            href="#example1" role="button" aria-controls="example1">
                                            Offcanvas with href
                                        </a>
                                        <button class="btn bg-info-subtle text-info" type="button"
                                            data-bs-toggle="offcanvas" data-bs-target="#example2"
                                        ...
                                        <button class="btn bg-secondary-subtle text-secondary" type="button"
