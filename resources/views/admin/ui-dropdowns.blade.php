                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Dropdowns</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Button with Dropdown</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Split button dropdowns</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Light Button with Dropdown</h5>
                                    </div>
                                    <div class="d-flex flex-wrap gap-6">
                                        <!-- Example single danger button -->
                                        <div class="btn-group">
                                            <button class="btn bg-danger-subtle text-danger dropdown-toggle"
                                        ...
                                        <!-- Example single danger button -->
                                        <div class="btn-group">
                                            <button class="btn bg-info-subtle text-info dropdown-toggle"
                                                type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                Action
                                            </button>
                                        ...
                                        <!-- Example single danger button -->
                                        <div class="btn-group">
                                            <button class="btn bg-warning-subtle text-warning dropdown-toggle"
                                                type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                Action
                                            </button>
                                        ...
                                        <!-- Example single danger button -->
                                        <div class="btn-group">
                                            <button class="btn bg-secondary-subtle text-secondary dropdown-toggle"
                                                type="button" id="dropdownMenuButton" data-bs-toggle="dropdown"
                                                aria-expanded="false">
                                                Action
                                            </button>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Light Split with Dropdown</h5>
                                    </div>
                                    <div class="d-flex flex-wrap gap-6">
                                        <!-- Example single danger button -->
                                        <div class="btn-group">
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <button type="button"
                                                class="btn bg-info-subtle text-info dropdown-toggle dropdown-toggle-split"
                                                data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                <span class="sr-only">Toggle Dropdown</span>
                                            </button>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Large button dropdowns</h5>
                                    </div>
                                    ...
                                    <div class="d-flex flex-wrap gap-6">
                                        <div class="btn-group">
                                            <button
                                                class="btn bg-secondary-subtle text-secondary  btn-lg dropdown-toggle"
                                        ...
                                        <div class="btn-group">
                                            <button class="btn bg-secondary-subtle text-secondary  btn-lg me-0"
                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Large button
                                            </button>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Small button dropdowns</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                    ...
                                    <div class="d-flex flex-wrap gap-6">
                                        <div class="btn-group">
                                            <button
                                                class="btn bg-secondary-subtle text-secondary  btn-sm dropdown-toggle"
                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Small button
                                            </button>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Large Dark Dropdown</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                    ...
                                    <div class="d-flex flex-wrap gap-6">
                                        ...
                                        <div class="btn-group">
                                            <button class="me-0 btn bg-secondary-subtle text-secondary btn-lg"
                                                type="button" data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Dark Dropdown
                                            </button>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Small Dark Dropdown</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Use <mark><code>dropdown-menu-dark</code></mark> for dark
                                        dropdown buttons.
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Animated Dropdowns</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Light Animated Dropdowns</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Give class to the button
                                        <mark><code>animated flipInX, flipInY, lightSpeedIn, slideInUp
                                    ...
                                    <div class="d-flex flex-wrap gap-6">
                                        ...
                                        <div class="btn-group">
                                            <button type="button"
                                                class="btn bg-danger-subtle text-danger dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Action
                                            </button>
                                        ...
                                        <div class="btn-group">
                                            <button type="button"
                                                class="btn bg-info-subtle text-info dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Action
                                            </button>
                                        ...
                                        <div class="btn-group">
                                            <button type="button"
                                                class="btn bg-warning-subtle text-warning dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Action
                                            </button>
                                        ...
                                        <div class="btn-group">
                                            <button type="button"
                                                class="btn bg-success-subtle text-success dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Action
                                            </button>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Animated Dropdowns with icon</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Give class to the button
                                        <mark><code>animated flipInX, flipInY, lightSpeedIn, slideInUp
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">
                                            Light Animated Button Dropdowns with icon
                                        </h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Give class to the button
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Direction of the Dropdown</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Menu Alignment</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                    ...
                                    <div class="d-flex flex-wrap gap-6">
                                        ...
                                        <div class="btn-group">
                                            <button type="button"
                                                class="me-0 btn bg-secondary-subtle text-secondary dropdown-toggle"
                                                data-bs-toggle="dropdown" aria-haspopup="true"
                                                aria-expanded="false">
                                                Left-aligned menu
                                            </button>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                <div class="card-body table-responsive">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Responsive Alignment</h5>
                                    </div>
                                    <div class="btn-group">
                                        <button type="button"
                                            class="btn bg-secondary-subtle text-secondary dropdown-toggle"
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-body button-group">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Different Menu Content</h5>
                                    </div>
                                    <div class="btn-group">
                                        <button type="button"
                                            class="btn bg-primary-subtle text-primary dropdown-toggle"
                                    ...
                                    <div class="d-flex">
                                        ...
                                        <div class="btn-group">
                                            <button type="button"
                                                class="btn bg-secondary-subtle text-secondary me-0">
                                                Reference
                                            </button>
                                            <button type="button"
                                                class="btn bg-secondary-subtle text-secondary dropdown-toggle dropdown-toggle-split"
