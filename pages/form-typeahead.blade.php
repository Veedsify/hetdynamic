                ...
                <div class="container-fluid">
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Typeahead</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-12 col-lg-12">
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">Multiple Datasets</h4>
                                </div>
                                <div class="card-body">
                                    <p class="card-subtitle mb-3">
                                        Multiple datasets give you visually separated sets of data
                                        inside Dropdown menu with <code>saperate titles</code>,
                                        managed in <code>templates</code> option. This looks like a
                                        <code>&lt;optgroup&gt;</code> titles in selects.
                                    </p>
