...
<head>
    ...
    <link rel="stylesheet" href="../assets/libs/pickadate-jalaali/lib/themes/default.css">
    <link rel="stylesheet" href="../assets/libs/pickadate-jalaali/lib/themes/default.date.css">
    <link rel="stylesheet" href="../assets/libs/pickadate-jalaali/lib/themes/default.time.css">
</head>
...
<body>
                ...
                <div class="container-fluid">
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Datetimepicker</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Datetimepicker</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">Pickadate Picker</h4>
                                </div>
                                <div class="card-body">
                                    <p class="card-subtitle mb-3">
                                        The mobile-friendly, responsive, and lightweight jQuery date
                                        &amp; time input picker.
                                    </p>
                                    <div class="mb-4">
                                        <label class="form-label">Default Pickadate</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate</code> class for default
                                            Pickadate Picker.
                                        </p>
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Hide/Change Buttons</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-clear-buttons</code> class to
                                            change/hide buttons.
                                        </p>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control pickadate-clear-buttons"
                                                placeholder="Hide/Change Buttons">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Select Year</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-select-year</code> class to
                                            choose select year.
                                        </p>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control pickadate-select-year"
                                                placeholder="Select Year">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Short string with Pickadate</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-short-string</code> class for
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pickadate-short-string"
                                                placeholder="Short String of Month &amp; Week">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Change First Week</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-firstweek</code> class to
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pickadate-firstweek"
                                                placeholder="First Weekday to Monday">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Date Limits</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-datelimits</code> class to
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pickadate-datelimits"
                                                placeholder="Date Limits">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Change Formats</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-change-format</code> class to
                                            change date formats.
                                        </p>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control pickadate-change-format"
                                                placeholder="Change Formats">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Language Translation</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-translations</code> class for
                                            language translation.
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickadate-translations"
                                                placeholder="In Different Language">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Change Arrows</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-changearrow</code> class to
                                            change date formats.
                                        </p>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control pickadate-changearrow"
                                                placeholder="Change Formats">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Disable arbitrary dates</label>
                                        <p class="card-subtitle mb-3">
                                            To use add
                                            <code>.pickadate-disable-arbitrarydates</code> class to
                                            disable arbitary dates.
                                        </p>
                                        <div class="input-group">
                                            <input type="text"
                                                class="form-control pickadate-disable-arbitrarydates"
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Disable days of the week</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-disable-week</code> class to
                                            disable days of the week.
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickadate-disable-week"
                                                placeholder="Disable days of the week">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Selectors Month &amp; Year</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-selectors</code> class to set
                                            month &amp; year selectors.
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickadate-selectors"
                                                placeholder="Selector Month &amp; Year">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Minimum and maximum date range</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-minmax</code> class for
                                            minimum and maximum date range.
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickadate-minmax"
                                                placeholder="In Another Language">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Dropdown Month &amp; Year</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-monyear-dropdown</code> class
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Picker Events</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-events</code> class to check
                                            events in the console.
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickadate-events"
                                                placeholder="Open console to verify events">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Native calendar of Disable picker</label>
                                        <p class="card-subtitle mb-3">
                                            To use <code>.datepicker</code> class to change Native
                                        ...
                                        <div class="input-group mb-3">
                                            ...
                                            <input id="picker_from" class="form-control datepicker"
                                                type="date">
                                        </div>
                                        <div class="input-group">
                                            <span class="input-group-text">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">Pickatime Picker</h4>
                                </div>
                                <div class="card-body">
                                    <div class="mb-4">
                                        <label class="form-label">Default Pickatime</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickatime</code> class for Default
                                            PickaDate Picker.
                                        </p>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control pickatime"
                                                placeholder="Default Pickatime">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Clear Button</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickadate-clear-buttons</code> class to
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Minimum and maximum time range</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickatime-minmax-range</code> class for
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pickatime-minmax-range"
                                                placeholder="maximum starting time and minimum ending time">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Change Formats</label>
                                        <p class="card-subtitle mb-3">
                                            Use <code>.pickadate-change-format</code> class to change
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Format of Label</label>
                                        <p class="card-subtitle mb-3">
                                            To use <code>.pickatime-format-label</code> class to
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control pickatime-format-label"
                                                placeholder="Format Label">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Time Format Display</label>
                                        <p class="card-subtitle mb-3">
                                            Use <code>.pickatime-formatTime-display</code> class to
                                            display time format.
                                        </p>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Current Time Limit</label>
                                        <p class="card-subtitle mb-3">
                                            Use for to show last 5 time limits and also shows current
                                            time Limitation.
                                        </p>
                                        <div class="input-group">
                                            <span class="input-group-text">
                                            ...
                                            <input type="text" class="form-control pickatime-time-limits"
                                                placeholder="Select Time limit">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Disable set of Time</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickatime-disable</code> for disable set
                                            of time.
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickatime-disable"
                                                placeholder="Disable set of Time">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Disable set of time using Object</label>
                                        <p class="card-subtitle mb-3">
                                            To use add
                                            <code>.pickatime-timedisable-object</code> class and using
                                            objects as a range of times
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickatime-timedisable-object"
                                                placeholder="Disable set of Time using obeject">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Disable set of time using Integers</label>
                                        <p class="card-subtitle mb-3">
                                            To use add
                                            <code>.pickatime-timedisable-integer</code> class and
                                            using integers as hours (0 to 23)
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickatime-timedisable-integer"
                                                placeholder="Disable set of Time using integers">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Disable All with exceptions</label>
                                        <p class="card-subtitle mb-3">
                                            Just add class <code>.pickatime-disable-all</code>
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickatime-disable-all"
                                                placeholder="Disable All with exceptions">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Close on a user action</label>
                                        <p class="card-subtitle mb-3">
                                            To use add <code>.pickatime-closeuser-action</code> class
                                            and use for When a time is selected or the "clear" button
                                            is pressed, the picker closes.
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickatime-closeuser-action"
                                                placeholder="Close on user Action">
                                    ...
                                    <div class="mb-4">
                                        <label class="form-label">Picker Events</label>
                                        <p class="card-subtitle mb-3">
                                            To use add just <code>pickatime-events</code> and to
                                            verify open console.
                                        </p>
                                        <div class="input-group">
                                            <input type="text" class="form-control pickatime-events"
                                                placeholder="Open console to verify events">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">With API</h4>
                                </div>
                                <div class="card-body">

                                    <div class="mb-4">
                                        <label class="form-label">Clear the Date</label>
                                        <div class="input-group">
                                            <button id="api_button_clear" class="btn btn btn-danger rounded-start"
                                                type="button">
                                                Clear date
                                            </button>

                                            <input id="api_picker_clear" class="datepicker form-control"
                                                value="15 October, 2010" data-value="2012-10-15" type="text">
                                        </div>
                                    </div>
                                    <div class="mb-4">
                                        <label class="form-label">Clear the Date With Inline Button</label>
                                        <div class="input-group">
                                            <input type="text" class="datepicker form-control"
                                                id="api_picker_clear_b" value="15 October, 2010"
                                                data-value="2012-10-15">

                                            <button class="btn btn-danger input-clear rounded-end"
                                                id="api_button_clear_b" type="button">
    ...
    <script src="../assets/libs/pickadate-jalaali/lib/compressed/picker.js"></script>
    <script src="../assets/libs/pickadate-jalaali/lib/compressed/picker.date.js"></script>
    <script src="../assets/libs/pickadate-jalaali/lib/compressed/picker.time.js"></script>
    <script src="../assets/libs/pickadate-jalaali/lib/compressed/legacy.js"></script>
    <script src="../assets/js/extra-libs/moment/moment.min.js"></script>
    <script src="../assets/libs/daterangepicker/daterangepicker.js"></script>
    <script src="../assets/js/forms/datetimepicker.init.js"></script>
</body>
