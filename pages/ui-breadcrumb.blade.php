                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Breadcrumb</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Default Breadcrumb</h5>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Custom Dividers</h5>
                                    </div>
                                    <nav class="py-2" style="--bs-breadcrumb-divider: '>'"
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Colored Breadcrumb</h5>
                                    </div>
                                    <nav aria-label="breadcrumb" class="mb-3">
                                        <ol class="breadcrumb bg-info-subtle px-3 py-2 rounded">
                                            <li class="breadcrumb-item">
                                                <a href="#" class="text-info d-flex align-items-center"><i
                                    ...
                                    <nav aria-label="breadcrumb" class="mb-3">
                                        <ol class="breadcrumb bg-warning-subtle px-3 py-2 rounded">
                                            <li class="breadcrumb-item">
                                                <a href="#" class="text-warning d-flex align-items-center"><i
                                                        class="ti ti-home fs-4 mt-1"></i></a>
                                            </li>
                                            <li class="breadcrumb-item">
                                                <a href="#" class="text-warning">Library</a>
                                            </li>
                                    ...
                                    <nav aria-label="breadcrumb" class="mb-3">
                                        <ol class="breadcrumb bg-danger-subtle px-3 py-2 rounded">
                                            <li class="breadcrumb-item">
                                                <a href="#" class="text-danger d-flex align-items-center"><i
                                                        class="ti ti-home fs-4 mt-1"></i></a>
                                            </li>
                                            <li class="breadcrumb-item">
                                    ...
                                    <nav aria-label="breadcrumb" class="mb-3">
                                        <ol class="breadcrumb bg-success-subtle px-3 py-2 rounded">
                                            <li class="breadcrumb-item">
                                                <a href="#" class="text-success d-flex align-items-center"><i
                                                        class="ti ti-home fs-4 mt-1"></i></a>
                                            </li>
                                            <li class="breadcrumb-item">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Colored Border Breadcrumb</h5>
                                    </div>
                                    <nav aria-label="breadcrumb" class="mb-3">
