                ...
                <div class="container-fluid">
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Ck Editor</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Ck Editor</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">Standard Preset Ck Editor</h4>
                                </div>
                                <div class="card-body">
                                    <textarea cols="80" id="testedit1" name="testedit1" rows="10" data-sample="2"
                                        data-sample-short="">
                                      &lt;h1&gt;&lt;img alt="Saturn V carrying Apollo 11" class="right" src="../assets/images/backgrounds/profile-bg.jpg" /&gt; Apollo 11&lt;/h1&gt;
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">Full Preset Ck Editor</h4>
                                </div>
                                <div class="card-body">
                                    <textarea cols="80" id="testedit2" name="testedit2" rows="10" data-sample="3"
                                        data-sample-short="">
                                      &lt;h1&gt;&lt;img alt="Saturn V carrying Apollo 11" class="right" src="../assets/images/backgrounds/profile-bg.jpg" /&gt; &lt;span style="color:#008080"&gt;&lt;span style="font-family:Georgia,serif"&gt;Apollo 11&lt;/span&gt;&lt;/span&gt;&lt;/h1&gt;
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">Toolbar Location Ck Editor</h4>
                                </div>
                                <div class="card-body">
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">Spelling Checker Ck Editor</h4>
                                </div>
                                <div class="card-body">
                                    <div id="editor">
                                        <h6>Hello...This is Test Text......!</h6>
                            ...
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">
                                        Additional Content With Ck Editor
                                    </h4>
                                </div>
                                <div class="card-body">
                                    <h6 class="card-subtitle">
                                        CKEditor is an Open source application, which means it can
                                        be modified in any way you want. It benefits from an active
                                        community that is constantly evolving the application with
                                        free add-ons and a transparent development process.
                                    </h6>
                                    <div class="form-group">
                                        <textarea name="ckeditor" id="ckeditor" cols="50" rows="15" class="ckeditor">
                                        <h1><img alt="Saturn V carrying Apollo 11" class="right" src="../assets/images/backgrounds/img1.jpg" height="250" /> Apollo 11</h1>
                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="border-bottom title-part-padding">
                                    <h4 class="card-title mb-0">Inline Editor</h4>
                                </div>
                                <div class="card-body">
                                    <div class="border p-3">
                                        <div id="editor2" contenteditable="true" class="inline-editor">
                                            ...
                                            <ul>
                                                <li>
                                                    Click the&nbsp;<strong>Source&nbsp;</strong>button to
                                                    display the HTML source of this text in the Source
                                                    dialog window.
                                                </li>
                                                <li>
                                                    Close the Source dialog window&nbsp;to return to the
                                                    WYSIWYG view.
                                                </li>
                                            </ul>
                                            <p>The following configuration option was used:</p>
