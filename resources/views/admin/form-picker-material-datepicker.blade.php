...
<head>
    ...
    <link rel="stylesheet"
        href="../../../ajax/libs/bootstrap-material-datetimepicker/2.7.1/css/bootstrap-material-datetimepicker.min.css">
</head>
...
<body>
                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Material-Datepicker</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Material-Datepicker</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <label class="mt-3 font-weight-medium mb-1">Default Material Date
                                                Picker</label>
                                            <input type="text" class="form-control" placeholder="2023-06-04"
                                                id="mdate">
                                            <label class="mt-3 font-weight-medium mb-1">Default Material Date
                                                Timepicker</label>
                                            <input type="text" id="date-format" class="form-control"
                                                placeholder="Saturday 24 June 2023 - 21:44">
                                        </div>
                                        <div class="col-12">
                                            <label class="mt-3 font-weight-medium mb-1">Time Picker</label>
                                            <input class="form-control" id="timepicker" placeholder="Check time">
                                            <label class="mt-3 font-weight-medium mb-1">Min Date set</label>
                                            <input type="text" class="form-control" placeholder="set min date"
                                                id="min-date">
                                        </div>
                                        <div class="col-12">
                                            <label class="mt-3 font-weight-medium mb-1">French Locales (Week starts at
                                                Monday)</label>
                                            <input class="form-control" id="date-fr"
                                                placeholder="Date de début">
                                            <label class="mt-3 font-weight-medium mb-1">Events</label>
                                            <input type="text" class="form-control" placeholder="Start Date"
                                                id="date-start">
                                            <input type="text" class="form-control mt-3" placeholder="End Date"
                                                id="date-end">
                                        </div>
                                    </div>
                                </div>
    ...
    <script src="../../../ajax/libs/bootstrap-material-datetimepicker/2.7.1/js/bootstrap-material-datetimepicker.min.js">
    </script>
