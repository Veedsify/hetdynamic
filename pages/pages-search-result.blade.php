                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Search Result</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Search Result</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="search-listing list-style-none">
                                        <li class="border-bottom">
                                            <h4 class="mb-0 fs-5">
                                                <a href="javacript:void(0)" class="">AngularJs</a>
                                            </h4>
                                            <a href="javascript:void(0)"
                                                class="search-links p-0 text-primary">http://www.google.com/angularjs</a>
                                            <p>
                                        ...
                                        <li class="border-bottom pt-3">
                                            <h4 class="mb-0 fs-5">
                                                <a href="javacript:void(0)" class="">AngularJS — Superheroic
                                                    JavaScript MVW Framework</a>
                                            </h4>
                                            <a href="javascript:void(0)"
                                                class="search-links p-0 text-primary">http://www.google.com/angularjs</a>
                                            <p>
                                        ...
                                        <li class="border-bottom pt-3">
                                            <h4 class="mb-0 fs-5">
                                                <a href="javacript:void(0)" class="">AngularJS Tutorial -
                                                    W3Schools</a>
                                            </h4>
                                            <a href="javascript:void(0)"
                                                class="search-links p-0 text-primary">http://www.google.com/angularjs</a>
                                        ...
                                        <li class="border-bottom pt-3">
                                            <h4 class="mb-0 fs-5">
                                                <a href="javacript:void(0)" class="">Introduction to AngularJS
                                                    - W3Schools</a>
                                            </h4>
                                            <a href="javascript:void(0)"
                                                class="search-links p-0 text-primary">http://www.google.com/angularjs</a>
                                        ...
                                        <li class="border-bottom pt-3">
                                            <h4 class="mb-0 fs-5">
                                                <a href="javacript:void(0)" class="">AngularJS Tutorial</a>
                                            </h4>
                                            <a href="javascript:void(0)"
                                                class="search-links p-0 text-primary">http://www.google.com/angularjs</a>
                                            <p>
                                        ...
                                        <li class="pt-3">
                                            <h4 class="mb-0 fs-5">
                                                <a href="javacript:void(0)" class="">Angular 2: One
                                                    framework.</a>
                                            </h4>
                                            <a href="javascript:void(0)"
                                                class="search-links p-0 text-primary">http://www.google.com/angularjs</a>
