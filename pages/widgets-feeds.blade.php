                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Widgets-Feeds</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Widgets-Feeds</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                        ...
                                        <div class="ms-auto">
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#">Turn on Post
                                                            Notifications</a>
                                                    </li>
                                                    <li>
                                    ...
                                    <div class="mt-4">
                                        <p class="fs-4">
                                            Your beauty is one of the things I like about you.😍 🥰<a
                                                href="#">#beauty</a>
                                            <a href="#">#goa🏄🏽‍♀️</a> <a href="#">#india</a>
                                            <a href="#">#happylife</a>
                                        </p>
                                    </div>
                                    <div class="d-flex align-items-center">
                                ...
                                <div class="comment-widgets">
                                    ...
                                    <div class="d-flex flex-row comment-row mt-0 p-3">
                                        ...
                                        <div class="comment-text w-100">
                                            ...
                                            <span class="mb-3 d-block">Lorem Ipsum is simply dummy text of the
                                                printing and
                                        ...
                                        <div class="comment-text w-100">
                                            ...
                                            <div class="comment-footer d-md-flex align-items-center">
                                                ...
                                                <div class="action-icons active ms-auto">
                                                    <a href="javascript:void(0)"><i data-feather="edit-3"
                                                            class="feather-sm"></i></a>
                                                    <a href="javascript:void(0)"><i data-feather="x-circle"
                                                            class="feather-sm"></i></a>
                                                    <a href="javascript:void(0)"><i data-feather="heart"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        <div class="embed-responsive embed-responsive-16by9">
                                            <iframe class="embed-responsive-item rounded" width="100%"
                                                height="350" src="https://www.youtube.com/embed/tgbNymZ7vqY"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <span class="text-muted d-block fs-4">Noise One Wireless Bluetooth
                                            Headset</span>
                                        <a href="#"
                                            class="text-info fs-4 font-weight-medium">https://www.flipkart.com/search?q=headphone&otracker=search&otracker1=search&marketplace=FLIPKART&as-show=on&as=off</a>
                                    </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="fs-4 mt-3">
                                        ...
                                        Excited!<a href="#">#PolestarCars</a> <a href="#">#cars</a>
                                        <a href="#">#india</a> <a href="#">#Polestar2</a>
                                    </p>
                                    <div class="mt-4 text-center">
                                        <a href="#" class="link">
                                            <div class="p-3 border rounded-1">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <a href="#"
                                            class="text-info fs-4 font-weight-medium">https://www.polestar.com/us/pole-star-2/</a>
                                    </div>
                                    <div class="d-flex align-items-center mt-3">
                                        <a href="#" class="me-3">
                                            <i class="ti ti-heart text-dark fs-7"></i>
