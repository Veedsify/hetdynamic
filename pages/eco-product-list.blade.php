                            ...
                            <div class="card-body p-3">
                                <div class="d-flex justify-content-between align-items-center gap-6 mb-9">
                                    ...
                                    <a class="fs-6 text-muted" href="javascript:void(0)" data-bs-toggle="tooltip"
                                        data-bs-placement="top" data-bs-title="Filter list"><i
                                    ...
                                    <table class="table align-middle text-nowrap mb-0">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="../assets/images/products/s1.jpg"
                                                            class="rounded-circle" alt="..." width="56"
                                                            height="56">
                                                        <div class="ms-3">
                                                            <h6 class="fw-semibold mb-0 fs-4">How Innovation Works
                                                            </h6>
                                                ...
                                                <td><a class="fs-6 text-muted" href="javascript:void(0)"
                                                        data-bs-toggle="tooltip" data-bs-placement="top"
                                                        data-bs-title="Edit"><i class="ti ti-dots-vertical"></i></a>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="../assets/images/products/s2.jpg"
                                                            ...
                                                            height="56">
                                                        <div class="ms-3">
                                                            <h6 class="fw-semibold mb-0 fs-4">Psalms Book for Growth
                                                            </h6>
                                                            <p class="mb-0">books</p>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        <img src="../assets/images/products/s3.jpg"
                                                            ...
                                                            height="56">
                                                        <div class="ms-3">
                                                            <h6 class="fw-semibold mb-0 fs-4">The Psychology of Money
                                                            </h6>
                                            ...
                                            <tr>
                                                ...
                                                <td class="border-bottom-0"><a class="fs-6 text-muted"
