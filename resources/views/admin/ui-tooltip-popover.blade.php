                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Tooltips</h4>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Tooltips Position</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Just put this to any tag
                                        <mark><code>data-bs-toggle="tooltip"
                                        title="Default
                        tooltip"</code></mark>
                                    </p>
                                    <div class="d-md-flex align-items-center button-group">
                                        <button type="button" class="me-2 btn bg-info-subtle text-info "
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="d-md-flex align-items-center button-group">
                                        <button type="button"
                                            class="me-2 btn bg-info-subtle text-info d-flex align-items-center "
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <a tabindex="0"
                                        class="btn bg-danger-subtle d-inline-flex align-items-center text-danger "
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <span class="d-inline-block" data-bs-toggle="popover"
                                        ...
                                        <button
                                            class="btn bg-primary-subtle text-primary  d-inline-flex align-items-center"
