                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Bootstrap UI</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Image with round corner</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Use Class for rounded image<mark><code>.rounded</code></mark>
                                    </p>
                                    <div class="text-center">
                                        <img src="../assets/images/blog/blog-img9.jpg" alt="image"
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Image with Circle</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Image Thumbnail</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
