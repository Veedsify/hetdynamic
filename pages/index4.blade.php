...
<body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            <div
                                                class="card overflow-hidden shadow-none border card-hover mb-4 mb-md-0">
                                                <img src="../assets/images/crypto/c1.jpg" alt="img">
                                                <div class="card-body p-4">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div>
                                                    ...
                                                    <div
                                                        class="d-flex align-items-start justify-content-between mt-3">
                                                        <span>Price</span>
                                                        <div class="text-end">
                                        ...
                                        <div class="col-md-4">
                                            <div
                                                class="card overflow-hidden shadow-none border card-hover mb-4 mb-md-0">
                                                <img src="../assets/images/crypto/c2.jpg" alt="img">
                                                <div class="card-body p-4">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div>
                                        ...
                                        <div class="col-md-4">
                                            <div
                                                class="card overflow-hidden shadow-none border card-hover mb-4 mb-md-0">
                                                <img src="../assets/images/crypto/c3.jpg" alt="img">
                                                <div class="card-body p-4">
                                                    <div class="d-flex align-items-center justify-content-between">
                                                        <div>
                                ...
                                <div class="card-body pb-2">
                                    <div class="d-md-flex align-items-center gap-3 justify-content-between mb-3">
                                        ...
                                        <div class="d-flex align-items-center gap-3 mt-4 mt-md-0">
                                            <div class="dropdown">
                                                <button class="btn bg-primary-subtle dropdown-toggle" type="button"
                                                    id="invest1" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                                            ...
                                            <div class="dropdown">
                                                <button class="btn bg-danger-subtle dropdown-toggle" type="button"
                                                    id="invest2" data-bs-toggle="dropdown"
                                                    aria-expanded="false">
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    ...
                                    <div class="input-group mb-3">
                                        ...
                                        <button
                                            class="btn arrow-none p-0 border-top border-bottom border-end border-0"
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-3">
                                        <span
                                            ...
                                            <img src="../assets/images/profile/user-1.jpg"
                                                class="rounded-circle me-1" alt="user1" width="30"> John
                                        </span>
                                    </div>
                                    <span class="d-block mb-1">Amount</span>
                                    <div class="input-group rounded">
                                        <input type="text" class="form-control  border-end-0"
                                            aria-label="Text input with dropdown button" value="$1000">
                                        <button class="btn p-0 border-top border-bottom border-end border-0"
                                            type="button">
    ...
    <script src="../assets/js/dashboards/dashboard4.js"></script>
</body>
