                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Select2</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Select2</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <select class="select2 js-events form-control" id="DOM-multiple"
                                        multiple="multiple">
                                        <optgroup label="Alaskan/Hawaiian Time Zone">
                                            <option value="AK">Alaska</option>
                                            <option value="HI">Hawaii</option>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="btn-toolbar mt-2" role="toolbar"
                                        ...
                                        <div class="btn-group btn-group-sm" aria-label="Set Select2 option">
                                            <button
                                                class="js-programmatic-set-val btn bg-primary-subtle text-primary  rounded-pill ms-2">
                                                Set "New Mexico"
                                            </button>
                                        </div>
                                        <div class="btn-group btn-group-sm" role="group"
                                            ...
                                            <button
                                                class="js-programmatic-open btn bg-primary-subtle text-primary  rounded-pill ms-2">
                                                Open
                                            </button>
                                            <button
                                                class="js-programmatic-close btn bg-primary-subtle text-primary  rounded-pill ms-2">
                                                Close
                                            </button>
                                        </div>
                                        <div class="btn-group btn-group-sm" role="group"
                                            ...
                                            <button
                                                class="js-programmatic-init btn bg-primary-subtle text-primary  rounded-pill ms-2">
                                                Init
                                            </button>
                                            <button
                                                class="js-programmatic-destroy btn bg-primary-subtle text-primary  rounded-pill ms-2">
                                                Destroy
                                            </button>
                                        </div>
                                    </div>
                                    <h5 class="mt-4">Programmatic Multiple</h5>
                                    <select class="select2 js-programmatic-multiple form-control"
                                    ...
                                    <div class="btn-group btn-group-sm mt-2" role="group"
                                        ...
                                        <button type="button"
                                            class="js-programmatic-multi-set-val btn bg-primary-subtle text-primary  rounded-pill">
                                            Set to New Mexico and Utah
                                        </button>
                                        <button type="button"
                                            class="js-programmatic-multi-clear btn bg-primary-subtle text-primary  rounded-pill ms-2">
                                            Clear
                                        </button>
                                    </div>
                                </div>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <select class="select2-with-bg form-control" id="bg-select"
                                        data-bgcolor="light-primary" data-text-color="text-primary">
                                        <optgroup label="Alaskan/Hawaiian Time Zone">
                                            <option value="AK">Alaska</option>
                                            <option value="HI">Hawaii</option>
                                        </optgroup>
                                    ...
                                    <select class="select2-with-menu-bg form-control" id="select2-with-menu-bg"
                                        data-bgcolor="primary" data-bgcolor-variation="light">
                                        <optgroup label="Alaskan/Hawaiian Time Zone">
                                            <option value="AK">Alaska</option>
                                            <option value="HI">Hawaii</option>
                                        </optgroup>
                                    ...
                                    <select class="select2-with-full-bg form-control w-100"
                                        id="select2-with-full-bg" data-bgcolor="light-info"
                                    ...
                                    <select class="select2-with-border border-info form-control"
                                        id="border-with-select2" data-border-color="info"
                                        data-border-variation="darken-2" data-text-color="info"
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <select class="select2-with-bg form-control" id="bg-multiple"
                                        multiple="multiple" data-bgcolor="light-info" data-bgcolor-variation=""
                                    ...
                                    <select class="select2-with-menu-bg form-control w-100" id="menu-bg-multiple"
                                    ...
                                    <select class="select2-with-full-bg form-control" id="full-bg-multiple"
                                        multiple="multiple" data-bgcolor="light-info" data-text-color="white">
                                        <optgroup label="Alaskan/Hawaiian Time Zone">
                                            <option value="AK">Alaska</option>
                                            <option value="HI">Hawaii</option>
                                        </optgroup>
                                    ...
                                    <select class="select2-with-border form-control" id="border-multiple"
                                        multiple="multiple" data-border-color="info"
