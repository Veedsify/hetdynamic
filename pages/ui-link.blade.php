                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Link</h4>
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Link opacity</h5>
                                    </div>
                                    <p><a class="link-opacity-10 text-decoration-underline" href="#">Link
                                            opacity 10</a></p>
                                    <p><a class="link-opacity-25 text-decoration-underline" href="#">Link
                                            opacity 25</a></p>
                                    <p><a class="link-opacity-50 text-decoration-underline" href="#">Link
                                            opacity 50</a></p>
                                    <p><a class="link-opacity-75 text-decoration-underline" href="#">Link
                                            opacity 75</a></p>
                                    <p><a class="link-opacity-100 text-decoration-underline" href="#">Link
                                            opacity 100</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Link Hover</h5>
                                    </div>
                                    <p><a class="link-opacity-10-hover text-decoration-underline"
                                            href="#">Link hover opacity 10</a></p>
                                    <p><a class="link-opacity-25-hover text-decoration-underline"
                                            href="#">Link hover opacity 25</a></p>
                                    <p><a class="link-opacity-50-hover text-decoration-underline"
                                            href="#">Link hover opacity 50</a></p>
                                    <p><a class="link-opacity-75-hover text-decoration-underline"
                                            href="#">Link hover opacity 75</a></p>
                                    <p><a class="link-opacity-100-hover text-decoration-underline"
                                            href="#">Link hover opacity 100</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Underline color</h5>
                                    </div>
                                    <p><a href="#"
                                            class="link-underline-primary text-decoration-underline">Primary
                                            underline</a></p>
                                    <p><a href="#"
                                            class="link-underline-secondary text-decoration-underline">Secondary
                                            underline</a></p>
                                    <p><a href="#"
                                            class="link-underline-success text-decoration-underline">Success
                                            underline</a></p>
                                    <p><a href="#"
                                            class="link-underline-danger text-decoration-underline">Danger
                                            underline</a></p>
                                    <p><a href="#"
                                            class="link-underline-warning text-decoration-underline">Warning
                                            underline</a></p>
                                    <p><a href="#" class="link-underline-info text-decoration-underline">Info
                                            underline</a></p>
                                    <p><a href="#"
                                            class="link-underline-light text-decoration-underline">Light underline</a>
                                    </p>
                                    <p><a href="#" class="link-underline-dark text-decoration-underline">Dark
                                            underline</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Underline offset</h5>
                                    </div>
                                    <p><a href="#">Default link</a></p>
                                    <p><a class="link-offset-1 text-decoration-underline" href="#">Offset 1
                                            link</a></p>
                                    <p><a class="link-offset-2 text-decoration-underline" href="#">Offset 2
                                            link</a></p>
                                    <p><a class="link-offset-3 text-decoration-underline" href="#">Offset 3
                                            link</a></p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Underline opacity</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Hover variants</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Colored links</h5>
                                    </div>
                                    <p><a href="#"
