                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">List</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Active List item</h5>
                                    </div>
                                    <ul class="list-group">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Disabled List item</h5>
                                    </div>
                                    <ul class="list-group">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">List with links</h5>
                                    </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">List with buttons</h5>
                                    </div>
                                    <div class="list-group">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">List with Flush</h5>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Horizontal list</h5>
                                    </div>
                                    <ul class="list-group list-group-horizontal">
                                        <li class="list-group-item d-md-flex align-items-center">
                                            <i
                                                class="ti ti-brand-chrome fs-4 me-2 mb-2 mb-md-0 flex-shrink-0 text-primary"></i>
                                            Todo List 1
                                        </li>
                                        <li class="list-group-item d-md-flex align-items-center">
                                            <i
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Horizontal list Up sm</h5>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Horizontal list Up md</h5>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Horizontal list Up lg</h5>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Horizontal list Up xl</h5>
                                    </div>
                                    <ul class="list-group">
                                        <li class="list-group-item d-flex align-items-center">
                                            <i class="ti ti-brand-chrome fs-4 me-2 text-primary"></i>
                                ...
                                <div class="card-body">
                                    ...
                                    <ul class="list-group">
                                        <li class="list-group-item d-flex align-items-center">
                                            ...
                                            Todo List 1
                                            <span
                                                class="badge bg-light-primary text-primary  rounded-pill ms-auto">14</span>
                                        </li>
                                        <li class="list-group-item d-flex align-items-center">
                                            <i class="ti ti-box fs-4 me-2 text-primary"></i>
                                            Todo List 2
                                            <span
                                                class="badge bg-light-danger text-danger  rounded-pill ms-auto">10</span>
                                        </li>
                                        <li class="list-group-item d-flex align-items-center">
                                            <i class="ti ti-box fs-4 me-2 text-primary"></i>
                                            Todo List 3
                                            <span
                                                class="badge bg-light-success text-success  rounded-pill ms-auto">01</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">JavaScript behavior</h5>
                                    </div>
                                    <div class="row">
                                        <div class="col-5">
                                            <div class="list-group" id="list-tab" role="tablist">
                                                ...
                                                <a class="list-group-item list-group-item-action" id="list-box-list"
                                                    data-bs-toggle="list" href="#list-box" role="tab"
                                                    aria-controls="box">Box</a>
                                                <a class="list-group-item list-group-item-action"
                                                    id="list-inbox-list" data-bs-toggle="list" href="#list-inbox"
                                                    role="tab" aria-controls="inbox">Inbox</a>
                                                <a class="list-group-item list-group-item-action"
                                                    id="list-spam-list" data-bs-toggle="list" href="#list-spam"
                                                    role="tab" aria-controls="spam">Spam</a>
                                            </div>
                                        </div>
                                        <div class="col-7">
                                            <div class="tab-content" id="nav-tabContent">
                                                ...
                                                <div class="tab-pane fade" id="list-box" role="tabpanel"
                                                    aria-labelledby="list-box-list">
                                                    <p>
                                                        Lorem Ipsum is simply dummy text of the printing
                                                        and typesetting industry. Lorem Ipsum has been the
                                                        industry's standard dummy text ever since the
                                                ...
                                                <div class="tab-pane fade" id="list-inbox" role="tabpanel"
                                                    aria-labelledby="list-inbox-list">
                                                    <p>
                                                        It is a long established fact that a reader will
                                                        be distracted by the readable content of a page
                                                        when looking at its layout. The point of using
                                                ...
                                                <div class="tab-pane fade" id="list-spam" role="tabpanel"
                                                    aria-labelledby="list-spam-list">
                                                    <p>
                                                        It is a long established fact that a reader will
                                                        be distracted by the readable content of a page
                                                        when looking at its layout. The point of using
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">List with checkbox</h5>
                                    </div>
                                    <ul class="list-group">
                                        <li class="list-group-item">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">List with radio</h5>
                                    </div>
                                    <ul class="list-group">
                                        <li class="list-group-item">
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="radio-btns"
                                                    value="" id="radio1">
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Numbered List item</h5>
                                    </div>
                        ...
                        <div class="col-lg-6">
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Numbered custom content List item</h5>
                                    </div>
                                    <ol class="list-group list-group-numbered">
                                        <li
                                            class="list-group-item d-flex justify-content-between align-items-start m-0">
