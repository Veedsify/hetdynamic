                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control xphone-inputmask"
                                            id="xphone-mask" placeholder="Enter Phone Number">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Purchase Order
                                            <small class="text-muted">aaaa 9999-****</small></label>
                                        <input type="text" class="form-control purchase-inputmask"
                                            id="purchase-mask" placeholder="Enter Purchase Order">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Credit Card Number
                                            <small class="text-muted">9999 9999 9999 9999</small></label>
                                        <input type="text" class="form-control cc-inputmask" id="cc-mask"
                                            placeholder="Enter Credit Card Number">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">SSN <small
                                                class="text-muted">999-99-9999</small></label>
                                        <input type="text" class="form-control ssn-inputmask" id="ssn-mask"
                                            placeholder="Enter Social Security Number">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">ISBN
                                            <small class="text-muted">999-99-999-9999-9</small></label>
                                        <input type="text" class="form-control isbn-inputmask" id="isbn-mask"
                                            placeholder="Enter ISBN">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Percentage <small
                                                class="text-muted">99%</small></label>
                                        <input type="text" class="form-control percentage-inputmask"
                                            id="percentage-mask" placeholder="Enter Value in %">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Currency<small class="text-muted">$9999</small>
                                        </label>
                                        <input type="text" class="form-control currency-inputmask"
                                            id="currency-mask" placeholder="Enter Currency in USD">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">Decimal using RadixPoint<small
                                                class="text-muted">123.654658</small>
                                        </label>
                                        <input type="text" class="form-control decimal-inputmask text-end"
                                            id="decimal-mask" placeholder="Enter Decimal Value">
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control optional-inputmask"
                                            id="optional-mask" placeholder="With Optional Mask">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">RTL attribute<small
                                                class="text-muted">dd/mm/yyyy</small>
                                        </label>
                                        <input type="text" class="form-control date-inputmask text-end"
                                            id="date-mask-rtl" placeholder="Enter Date">
                                    </div>
                                    <div class="mb-3">
                                        <label class="form-label">3 Number and 3 Lettter<small
                                                class="text-muted">123-ABC</small></label>
