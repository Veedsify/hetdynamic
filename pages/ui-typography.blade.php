                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Heading with P tag</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <p class="mb-3 card-subtitle">
                                        ...
                                        placed outside the
                                        <mark><code>&lt;blockquote&gt;</code></mark>. When providing attribution, wrap
                                        your
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Blockquote Alignment - Center</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Blockquote Alignment - End</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Use text utilities as needed to change the alignment of
                                        your blockquote.
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">List Unstyled</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Description list alignment</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Fancy Listing</h5>
                                    </div>
                                    <ul class="list-style-none">
                                        <li>
                                            <a href="javascript:void(0)" class="link-dark"><i
                                                    class="ti ti-check me-2 fs-4 text-info"></i>
