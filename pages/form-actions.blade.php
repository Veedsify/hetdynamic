                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Form Actions</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Form Actions</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div>
                                            <div class="mb-3 mb-0 text-start">
                                                ...
                                                <button type="submit"
                                                    class="btn bg-danger-subtle text-danger rounded-pill px-4">
                                                    Cancel
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body border-top">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="inputname"
                                                        class="control-label col-form-label">First Name</label>
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="inputlname"
                                                        class="control-label col-form-label">Last Name</label>
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="inputcontact"
                                                        class="control-label col-form-label">Contact No</label>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body pb-0">
                                    ...
                                    <div class="alert bg-primary-subtle text-info alert-dismissible fade show"
                                        role="alert">
                                        <div class="d-flex align-items-center text-primary ">
                                            <i class="ti ti-info-circle me-2 fs-4"></i>
                                ...
                                <div class="card-body border-top">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                <label for="inputfname" class="control-label col-form-label">First
                                                    Name</label>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                <label for="inputlname2" class="control-label col-form-label">Last
                                                    Name</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                <label for="uname"
                                                    class="control-label col-form-label">Username</label>
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                <label for="nname" class="control-label col-form-label">Nick
                                                    Name</label>
                                ...
                                <div class="card-body border-top">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                <label for="wen1"
                                                    class="control-label col-form-label">Website</label>
                                                <input type="text" class="form-control" id="wen1"
                                                    placeholder="http://">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="mb-3">
                                                <label for="cono" class="control-label col-form-label">Contact
                                                    No</label>
                                ...
                                <div class="p-3 border-top">
                                    <div>
                                        <div class="mb-3 mb-0 text-end">
                                            ...
                                            <button type="submit"
                                                class="btn bg-danger-subtle text-danger rounded-pill ms-6 px-4">
                                                Cancel
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <form>
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="fname1" class="control-label col-form-label">Full
                                                        Name</label>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="donate1"
                                                        class="control-label col-form-label">Donation Type</label>
                                                    <input type="text" class="form-control" id="donate1"
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="emp1"
                                                        class="control-label col-form-label">Employee</label>
                                                    <input type="text" class="form-control" id="emp1"
                                        ...
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="datec" class="control-label col-form-label">Date
                                                        of Complaint</label>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="suname"
                                                        class="control-label col-form-label">Supervisor's Name</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="sign"
                                                        class="control-label col-form-label">Signature</label>
                                ...
                                <form>
                                    ...
                                    <div class="card-body border-top">
                                        <div class="row">
                                            <div class="col-12">
                                                <label for="inputEmail3"
                                                    class="control-label col-form-label">Employee Name</label>
                                                <div class="input-group">
                                                    <span class="input-group-text" id="basic-addon1">
                                                        <i class="ti ti-user fs-4"></i>
                                                    </span>
                                                    <input type="text" class="form-control"
                                                        placeholder="Employee Name here" aria-label="Username"
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="inputEmail3"
                                                        class="control-label col-form-label">Project Name</label>
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon1">
                                                            <i class="ti ti-briefcase fs-4"></i>
                                                        </span>
                                                        <input type="text" class="form-control"
                                                            placeholder="Project Name here" aria-label="Username"
                                                            aria-describedby="basic-addon1">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="inputEmail3"
                                                        class="control-label col-form-label">Date</label>
                                                    <div class="input-group">
                                                        <span class="input-group-text" id="basic-addon1">
                                            ...
                                            <div class="col-12">
                                                <label for="inputEmail3" class="control-label col-form-label">Rate
                                                    Per Hour</label>
                                                <div class="input-group">
                                                    <span class="input-group-text">$</span>
                                                    <input type="text" class="form-control"
                                ...
                                <form>
                                    ...
                                    <div class="card-body border-top">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="isst" class="control-label col-form-label">Issue
                                                        Title</label>
                                                    <input type="text" class="form-control" id="isst"
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="open"
                                                        class="control-label col-form-label">Opened By</label>
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="dateopen" class="control-label col-form-label">Date
                                                        Opened</label>
                                            ...
                                            <div class="col-sm-12 col-md-6">
                                                <div class="mb-3">
                                                    <label for="datefixe" class="control-label col-form-label">Date
                                                        Fixed</label>
                                ...
                                <form>
                                    ...
                                    <div class="card-body border-top">
                                        <div class="row m-auto">
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="fname3" class="control-label col-form-label">Full
                                                        Name</label>
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label for="comname1"
                                                        class="control-label col-form-label">Company Name</label>
                                                    <input type="text" class="form-control" id="comname1"
                                                        placeholder="Company Name Here">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                            ...
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <div class="mb-3">
                                                        <label for="conno2"
                                                            class="control-label col-form-label">Contact No</label>
                                                        <input type="text" class="form-control" id="conno2"
                                                            placeholder="Contact no Here">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-3">
                                                    <label class="control-label col-form-label">Existing
                                                        Customer</label>
