                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Form Repeater</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Form Repeater</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                                                ...
                                                <form>
                                                    <div class="row">
                                                        ...
                                                        <div class="mb-3 col-md-12">
                                                            <button class="btn rounded-pill px-4 btn-primary"
                                                                type="submit">
                                                                <i class="ti ti-send fs-5"></i>
                                                                Submit
                                                            </button>
                                                            <button data-repeater-delete=""
                                                                class="btn rounded-pill px-4 bg-danger-subtle text-danger ms-6"
                                                                type="button">
                                ...
                                <div class="card-body">
                                    <form class="mt-4">
                                        <div>
                                            ...
                                            <div class="mb-3">
                                                <button class="btn rounded-pill px-4 btn-primary" type="submit">
                                                    <i class="ti ti-send fs-5"></i>
                                                    Submit
                                                </button>
                                            </div>
                                        ...
                                        <div class="col-sm-2">
                                            <div class="mb-3">
                                                <button onclick="education_fields();"
                                                    class="btn btn-success font-weight-medium" type="button">
