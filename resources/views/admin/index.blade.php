...
<div class="fixed-profile p-3 mx-4 mb-2 bg-secondary-subtle rounded mt-3">
  <div class="hstack gap-3">
    <div class="john-img">
      <img src="{{asset("admin-assets/images/profile/user-1.jpg")}}" class="rounded-circle" width="40" height="40" alt="">
    </div>
            ...
            <div class="position-relative">
              <a href="app-chat.html" class="d-flex align-items-center pb-9 position-relative">
                <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                  <img src="{{asset("admin-assets/images/svgs/icon-dd-chat.svg")}}" alt="" class="img-fluid" width="24" height="24">
                </div>
              ...
              <a href="app-invoice.html" class="d-flex align-items-center pb-9 position-relative">
                <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                  <img src="{{asset("admin-assets/images/svgs/icon-dd-invoice.svg")}}" alt="" class="img-fluid" width="24" height="24">
                </div>
                <div class="d-inline-block">
              ...
              <a href="app-contact2.html" class="d-flex align-items-center pb-9 position-relative">
                <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                  <img src="{{asset("admin-assets/images/svgs/icon-dd-mobile.svg")}}" alt="" class="img-fluid" width="24" height="24">
                </div>
                <div class="d-inline-block">
                  <h6 class="mb-1 fw-semibold fs-3">
                    Contact Application
              ...
              <a href="app-email.html" class="d-flex align-items-center pb-9 position-relative">
                <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                  <img src="{{asset("admin-assets/images/svgs/icon-dd-message-box.svg")}}" alt="" class="img-fluid" width="24" height="24">
                </div>
                <div class="d-inline-block">
          ...
          <div class="col-6">
            <div class="position-relative">
              <a href="page-user-profile.html" class="d-flex align-items-center pb-9 position-relative">
                <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                  <img src="{{asset("admin-assets/images/svgs/icon-dd-cart.svg")}}" alt="" class="img-fluid" width="24" height="24">
                </div>
                <div class="d-inline-block">
                  <h6 class="mb-1 fw-semibold fs-3">
                    User Profile
              ...
              <a href="app-calendar.html" class="d-flex align-items-center pb-9 position-relative">
                <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                  <img src="{{asset("admin-assets/images/svgs/icon-dd-date.svg")}}" alt="" class="img-fluid" width="24" height="24">
                </div>
                <div class="d-inline-block">
                  <h6 class="mb-1 fw-semibold fs-3">
                    Calendar App
              ...
              <a href="app-contact.html" class="d-flex align-items-center pb-9 position-relative">
                <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                  <img src="{{asset("admin-assets/images/svgs/icon-dd-lifebuoy.svg")}}" alt="" class="img-fluid" width="24" height="24">
                </div>
                <div class="d-inline-block">
                  <h6 class="mb-1 fw-semibold fs-3">
                    Contact List Table
              ...
              <a href="app-notes.html" class="d-flex align-items-center pb-9 position-relative">
                <div class="text-bg-light rounded-1 me-3 p-6 d-flex align-items-center justify-content-center">
                  <img src="{{asset("admin-assets/images/svgs/icon-dd-application.svg")}}" alt="" class="img-fluid" width="24" height="24">
                </div>
                <div class="d-inline-block">
                  <h6 class="mb-1 fw-semibold fs-3">
                    Notes Application
      ...
      <ul class="navbar-nav flex-row ms-auto align-items-center justify-content-center">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link nav-icon-hover" href="javascript:void(0)" id="drop2" data-bs-toggle="dropdown" aria-expanded="false">
            <img src="{{asset("admin-assets/images/svgs/icon-flag-en.svg")}}" alt="" width="20px" height="20px" class="rounded-circle object-fit-cover round-20">
          </a>
          <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
            <div class="message-body">
              ...
              <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                <div class="position-relative">
                  <img src="{{asset("admin-assets/images/svgs/icon-flag-cn.svg")}}" alt="" width="20px" height="20px" class="rounded-circle object-fit-cover round-20">
                </div>
                <p class="mb-0 fs-3">中国人 (Chinese)</p>
              </a>
              <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                <div class="position-relative">
                  <img src="{{asset("admin-assets/images/svgs/icon-flag-fr.svg")}}" alt="" width="20px" height="20px" class="rounded-circle object-fit-cover round-20">
                </div>
                <p class="mb-0 fs-3">français (French)</p>
              </a>
              <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                <div class="position-relative">
                  <img src="{{asset("admin-assets/images/svgs/icon-flag-sa.svg")}}" alt="" width="20px" height="20px" class="rounded-circle object-fit-cover round-20">
                </div>
...
<div class="py-6 px-7 mb-1">
          ...
          <a class="nav-link pe-0" href="javascript:void(0)" id="drop1" data-bs-toggle="dropdown" aria-expanded="false">
            <div class="d-flex align-items-center">
              <div class="user-profile-img">
                <img src="{{asset("admin-assets/images/profile/user-1.jpg")}}" class="rounded-circle" width="35" height="35" alt="">
              </div>
            </div>
          </a>
  ...
  <div class="d-flex align-items-center py-9 mx-7 border-bottom">
    <img src="{{asset("admin-assets/images/profile/user-1.jpg")}}" class="rounded-circle" width="80" height="80" alt="">
    <div class="ms-3">
  ...
  <div class="message-body">
    <a href="page-user-profile.html" class="py-8 px-7 mt-8 d-flex align-items-center">
      <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
        <img src="{{asset("admin-assets/images/svgs/icon-account.svg")}}" alt="" width="24" height="24">
      </span>
    ...
    <a href="app-email.html" class="py-8 px-7 d-flex align-items-center">
      <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
        <img src="{{asset("admin-assets/images/svgs/icon-inbox.svg")}}" alt="" width="24" height="24">
      </span>
      <div class="w-75 d-inline-block v-middle ps-3">
    ...
    <a href="app-notes.html" class="py-8 px-7 d-flex align-items-center">
      <span class="d-flex align-items-center justify-content-center text-bg-light rounded-1 p-6">
        <img src="{{asset("admin-assets/images/svgs/icon-tasks.svg")}}" alt="" width="24" height="24">
      </span>
      <div class="w-75 d-inline-block v-middle ps-3">
      ...
      <div class="row">
        ...
        <div class="col-6">
          <div class="m-n4 unlimited-img">
            <img src="{{asset("admin-assets/images/backgrounds/unlimited-bg.png")}}" alt="" class="w-100">
          </div>
        </div>
      </div>
    </div>
  ...
  <ul class="navbar-nav">
    ...
    <li class="nav-item d-none d-xl-block">
      <a href="index.html" class="text-nowrap nav-link">
        <img src="{{asset("admin-assets/images/logos/dark-logo.svg")}}" class="dark-logo" width="180" alt="">
        <img src="{{asset("admin-assets/images/logos/light-logo.svg")}}" class="light-logo" width="180" alt="">
      </a>
    </li>
    <li class="nav-item d-none d-xl-block">
      <a class="nav-link nav-icon-hover" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <div class="owl-carousel counter-carousel owl-theme">
                ...
                <div class="card border-0 zoom-in bg-primary-subtle shadow-none">
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{asset("admin-assets/images/svgs/icon-user-male.svg")}}" width="50" height="50" class="mb-3" alt="">
              ...
              <div class="item">
                <div class="card border-0 zoom-in bg-warning-subtle shadow-none">
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{asset("admin-assets/images/svgs/icon-briefcase.svg")}}" width="50" height="50" class="mb-3" alt="">
              ...
              <div class="item">
                <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{asset("admin-assets/images/svgs/icon-mailbox.svg")}}" width="50" height="50" class="mb-3" alt="">
              ...
              <div class="item">
                <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{asset("admin-assets/images/svgs/icon-favorites.svg")}}" width="50" height="50" class="mb-3" alt="">
              ...
              <div class="item">
                <div class="card border-0 zoom-in bg-success-subtle shadow-none">
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{asset("admin-assets/images/svgs/icon-speech-bubble.svg")}}" width="50" height="50" class="mb-3" alt="">
              ...
              <div class="item">
                <div class="card border-0 zoom-in bg-info-subtle shadow-none">
                  <div class="card-body">
                    <div class="text-center">
                      <img src="{{asset("admin-assets/images/svgs/icon-connect.svg")}}" width="50" height="50" class="mb-3" alt="">
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center mb-7 pb-2">
                      <div class="me-3 pe-1">
                        <img src="{{asset("admin-assets/images/profile/user-2.jpg")}}" class="shadow-warning rounded-2" alt="" width="72" height="72">
                      </div>
                      <div>
                      ...
                      <ul class="hstack mb-0">
                        <li class="ms-n8">
                          <a href="javascript:void(0)" class="me-1">
                            <img src="{{asset("admin-assets/images/profile/user-2.jpg")}}" class="rounded-circle border border-2 border-white" width="44" height="44" alt="">
                          </a>
                        </li>
                        <li class="ms-n8">
                          <a href="javascript:void(0)" class="me-1">
                            <img src="{{asset("admin-assets/images/profile/user-3.jpg")}}" class="rounded-circle border border-2 border-white" width="44" height="44" alt="">
                          </a>
                        </li>
                        <li class="ms-n8">
                          <a href="javascript:void(0)" class="me-1">
                            <img src="{{asset("admin-assets/images/profile/user-4.jpg")}}" class="rounded-circle border border-2 border-white" width="44" height="44" alt="">
                          </a>
                        </li>
                        <li class="ms-n8">
                          <a href="javascript:void(0)" class="me-1">
                            <img src="{{asset("admin-assets/images/profile/user-5.jpg")}}" class="rounded-circle border border-2 border-white" width="44" height="44" alt="">
                          </a>
                        </li>
                      </ul>
                ...
                <div class="card text-bg-primary border-0 w-100">
                  <div class="card-body pb-0">
                    ...
                    <div class="text-center mt-3">
                      <img src="{{asset("admin-assets/images/backgrounds/piggy.png")}}" class="img-fluid" alt="">
                    </div>
                  </div>
                        ...
                        <tbody class="border-top">
                          <tr>
                            <td class="ps-0">
                              <div class="d-flex align-items-center">
                                <div class="me-2 pe-1">
                                  <img src="{{asset("admin-assets/images/profile/user-2.jpg")}}" class="rounded-circle" width="40" height="40" alt="">
                                </div>
                                <div>
                          ...
                          <tr>
                            <td class="ps-0">
                              <div class="d-flex align-items-center">
                                <div class="me-2 pe-1">
                                  <img src="{{asset("admin-assets/images/profile/user-3.jpg")}}" class="rounded-circle" width="40" height="40" alt="">
                                </div>
                                <div>
                          ...
                          <tr>
                            <td class="ps-0">
                              <div class="d-flex align-items-center">
                                <div class="me-2 pe-1">
                                  <img src="{{asset("admin-assets/images/profile/user-4.jpg")}}" class="rounded-circle" width="40" height="40" alt="">
                                </div>
                                <div>
                          ...
                          <tr>
                            <td class="ps-0">
                              <div class="d-flex align-items-center">
                                <div class="me-2 pe-1">
                                  <img src="{{asset("admin-assets/images/profile/user-5.jpg")}}" class="rounded-circle" width="40" height="40" alt="">
                                </div>
                                <div>
                          ...
                          <tr>
                            <td class="border-0 ps-0">
                              <div class="d-flex align-items-center">
                                <div class="me-2 pe-1">
                                  <img src="{{asset("admin-assets/images/profile/user-6.jpg")}}" class="rounded-circle" width="40" height="40" alt="">
                                </div>
                                <div>
...
<div class="offcanvas offcanvas-end shopping-cart" tabindex="-1" id="offcanvasRight" aria-labelledby="offcanvasRightLabel">
  ...
  <div class="offcanvas-body h-100 px-4 pt-0" data-simplebar="">
    <ul class="mb-0">
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img src="{{asset("admin-assets/images/products/product-1.jpg")}}" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="">
          <div>
      ...
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img src="{{asset("admin-assets/images/products/product-2.jpg")}}" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="">
          <div>
            <h6 class="mb-1">Supreme toys cooker</h6>
            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
            <div class="d-flex align-items-center justify-content-between mt-2">
      ...
      <li class="pb-7">
        <div class="d-flex align-items-center">
          <img src="{{asset("admin-assets/images/products/product-3.jpg")}}" width="95" height="75" class="rounded-1 me-9 flex-shrink-0" alt="">
          <div>
            <h6 class="mb-1">Supreme toys cooker</h6>
            <p class="mb-0 text-muted fs-2">Kitchenware Item</p>
            <div class="d-flex align-items-center justify-content-between mt-2">
