...
<body>
    <font face="Verdana" style="font-size: 16px; line-height: 1.6;">
        <div style="margin: 0 auto; max-width: 600px; background: #ececec;">
            ...
            <div style="padding: 20px;">
                ...
                <p><strong>Message <br> :</strong> {{ $user->message }}</p>
            </div>
