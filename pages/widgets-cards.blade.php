                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <a href="page-user-profile.html"
                                class="p-4 text-center bg-primary-subtle card shadow-none rounded-2">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <a href="javascript:void(0)"
                                class="p-4 text-center bg-warning-subtle card shadow-none rounded-2">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <a href="app-calendar.html"
                                class="p-4 text-center bg-info-subtle card shadow-none rounded-2">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <a href="app-email.html"
                                class="p-4 text-center bg-danger-subtle card shadow-none rounded-2">
                        ...
                        <div class="col-sm-6 col-lg-4 col-xl-2">
                            <a href="app-chat.html"
                                class="p-4 text-center bg-success-subtle card shadow-none rounded-2">
                                <img src="../assets/images/svgs/icon-speech-bubble.svg" width="50"
                                    height="50" class="mb-6 mx-auto" alt="">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="card rounded-2 overflow-hidden hover-img">
                                <div class="position-relative">
                                    ...
                                    <span
                                        class="badge text-bg-light text-dark fs-2 rounded-4 lh-sm mb-9 me-9 py-1 px-2 fw-semibold position-absolute bottom-0 end-0">2
                                        min Read</span>
                                ...
                                <div class="card-body p-4">
                                    <span
                                        class="badge text-bg-light fs-2 rounded-4 py-1 px-2 lh-sm  mt-3">Social</span>
                                    ...
                                    <div class="d-flex align-items-center gap-4">
                                        ...
                                        <div class="d-flex align-items-center fs-2 ms-auto"><i
                                                class="ti ti-point text-dark"></i>Mon, Dec 19
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card rounded-2 overflow-hidden hover-img">
                                ...
                                <div class="card-body p-4">
                                    <span
                                        class="badge text-bg-light fs-2 rounded-4 py-1 px-2 lh-sm  mt-3">Gadget</span>
                                    <a class="d-block my-4 fs-5 text-dark fw-semibold" href="">Intel loses
                                    ...
                                    <div class="d-flex align-items-center gap-4">
                                        ...
                                        <div class="d-flex align-items-center fs-2 ms-auto"><i
                                                class="ti ti-point text-dark"></i>Sun, Dec 18
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="card rounded-2 overflow-hidden hover-img">
                                ...
                                <div class="card-body p-4">
                                    <span
                                        class="badge text-bg-light fs-2 rounded-4 py-1 px-2 lh-sm  mt-3">Health</span>
                                    <a class="d-block my-4 fs-5 text-dark fw-semibold" href="">COVID outbreak
                                        deepens as more lockdowns
                                        loom in China</a>
                                    <div class="d-flex align-items-center gap-4">
                                        <div class="d-flex align-items-center gap-2"><i
                                        ...
                                        <div class="d-flex align-items-center fs-2 ms-auto"><i
                                                class="ti ti-point text-dark"></i>Sat, Dec 17
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="card rounded-2 overflow-hidden">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="fw-semibold fs-4 mb-2">Boat Headphone</h5>
                                    <div class="d-flex align-items-center justify-content-between">
                                        ...
                                        <ul class="d-flex align-items-center gap-1 mb-0">
                                            <li><a href="javascript:void(0)" class="text-warning"><i
                                                        class="ti ti-star"></i></a></li>
                                            <li><a href="javascript:void(0)" class="text-warning"><i
                                                        class="ti ti-star"></i></a></li>
                                            <li><a href="javascript:void(0)" class="text-warning"><i
                                                        class="ti ti-star"></i></a></li>
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card rounded-2 overflow-hidden">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="fw-semibold fs-4 mb-2">MacBook Air Pro</h5>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card rounded-2 overflow-hidden">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="fw-semibold fs-4 mb-2">Red Valvet Dress</h5>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-2">
                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="card rounded-2 overflow-hidden">
                                ...
                                <div class="card-body p-4">
                                    <h5 class="fw-semibold fs-4 mb-2">Cute Soft Teddybear</h5>
                                    <div class="d-flex align-items-center justify-content-between">
                                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="card rounded-2 overflow-hidden">
                                <div class="row">
                                    <div class="col-6 pe-0">
                                        <div class="p-4 mb-7">
                                            <h5 class="fw-semibold fs-5 mb-1">Uptown Funk</h5>
                                            <p class="mb-0">Jon Bon Jovi</p>
                                        </div>
                                        <ul
                                            class="d-flex align-items-center justify-content-between mb-0 list-unstyled px-3 pb-7">
                                    ...
                                    <div class="col-6 ps-0">
                                        <div class="position-relative w-100 h-100">
                                            <img src="../assets/images/blog/blog-img5.jpg"
                                                class="w-100 h-100 rounded-0" alt="">
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="card rounded-2 overflow-hidden">
                                <div class="row">
                                    <div class="col-6 pe-0">
                                        <div class="p-4 mb-7">
                                            <h5 class="fw-semibold fs-5 mb-1">Blank Space</h5>
                                    ...
                                    <div class="col-6 ps-0">
                                        <div class="position-relative w-100 h-100">
                                            <img src="../assets/images/blog/blog-img4.jpg"
                                                class="w-100 h-100 rounded-0" alt="">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="card rounded-2 overflow-hidden">
                                <div class="row">
                                    <div class="col-6 pe-0">
                                        <div class="p-4 mb-7">
                                            <h5 class="fw-semibold fs-5 mb-1">Lean On</h5>
                            ...
                            <div class="card">
                                <div class="card-body p-4 d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-3.jpg" alt=""
                                        class="rounded-circle" width="40" height="40">
                                    <div>
                                        <h5 class="fw-semibold mb-0">Leo Pratt</h5>
                                        <span class="fs-2 d-flex align-items-center"><i
                            ...
                            <div class="card">
                                <div class="card-body p-4 d-flex align-items-center gap-3">
                                    <img src="../assets/images/profile/user-4.jpg" alt=""
                                        class="rounded-circle" width="40" height="40">
                                    <div>
                                        <h5 class="fw-semibold mb-0">Charles Nunez</h5>
                                        <span class="fs-2 d-flex align-items-center"><i
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <div class="card-body p-4">
                                    ...
                                    <h5 class="mb-2 fw-semibold fs-4">Andrew Grant</h5>
                                    <div class="d-flex align-items-center gap-4 mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="#">
                                                <img src="../assets/images/profile/user-2.jpg"
                                                    class="rounded-circle me-n2 card-hover border border-white"
                                                    width="32" height="32">
                                            </a>
                                            <a href="#">
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <div class="card-body p-4">
                                    <img src="../assets/images/profile/user-3.jpg" alt=""
                                        class="img-fluid rounded-circle mb-4" width="80" height="80">
                                    <h5 class="mb-2 fw-semibold fs-4">Leo Pratt</h5>
                                    <div class="d-flex align-items-center gap-4 mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="#">
                                                <img src="../assets/images/profile/user-2.jpg"
                        ...
                        <div class="col-sm-6 col-lg-3">
                            <div class="card">
                                <div class="card-body p-4">
                                    <img src="../assets/images/profile/user-4.jpg" alt=""
                                        class="img-fluid rounded-circle mb-4" width="80" height="80">
                                    <h5 class="mb-2 fw-semibold fs-4">Charles Nunez</h5>
                                    <div class="d-flex align-items-center gap-4 mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="#">
                                                <img src="../assets/images/profile/user-2.jpg"
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    <img src="../assets/images/profile/user-5.jpg" alt=""
                                        class="img-fluid rounded-circle mb-4" width="80" height="80">
                                    <h5 class="mb-2 fw-semibold fs-4">Lora Powers</h5>
                                    <div class="d-flex align-items-center gap-4 mb-4">
                                        <div class="d-flex align-items-center">
                                            <a href="#">
                                                <img src="../assets/images/profile/user-2.jpg"
                        ...
                        <div class="col-md-4">
                            <div class="card hover-img">
                                <div class="card-body p-4 text-center border-bottom">
                                    ...
                                    <h5 class="fw-semibold mb-0 fs-5">Betty Adams</h5>
                                    <span class="text-dark fs-2">Medical Secretary</span>
                                </div>
                                <ul
                                    class="px-2 py-2 list-unstyled d-flex align-items-center justify-content-center mb-0">
                        ...
                        <div class="col-md-4">
                            <div class="card hover-img">
                                <div class="card-body p-4 text-center border-bottom">
                                    <img src="../assets/images/profile/user-3.jpg" alt=""
                                        class="rounded-circle mb-3" width="80" height="80">
                                    <h5 class="fw-semibold mb-0 fs-5">Leo Pratt</h5>
                                    <span class="text-dark fs-2">Telecom Analyst</span>
                                </div>
                                <ul
                                    class="px-2 py-2 list-unstyled d-flex align-items-center justify-content-center mb-0">
                                    <li class="position-relative">
                        ...
                        <div class="col-md-4">
                            <div class="card hover-img">
                                <div class="card-body p-4 text-center border-bottom">
                                    <img src="../assets/images/profile/user-4.jpg" alt=""
                                        class="rounded-circle mb-3" width="80" height="80">
                                    <h5 class="fw-semibold mb-0 fs-5">Charles Nunez</h5>
                                    <span class="text-dark fs-2">Environmental Specialist</span>
                                </div>
                                <ul
                                    class="px-2 py-2 list-unstyled d-flex align-items-center justify-content-center mb-0">
                                    <li class="position-relative">
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    ...
                                    <div class="d-flex align-items-center gap-3 pb-3 mb-3 border-bottom">
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="text-bg-primary rounded-2 d-flex align-items-center justify-content-center p-6">
                                    ...
                                    <div class="d-flex align-items-center gap-3 pb-3 border-bottom mb-3">
                                        <div class="d-flex align-items-center">
                                            <div
                                                class="text-bg-secondary rounded-2 d-flex align-items-center justify-content-center p-6">
                                                <i class="ti ti-message text-white fs-7"></i>
                                            </div>
                                        </div>
                                        <div
                                            class="position-relative w-100 d-flex align-items-center justify-content-between">
                                            <div>
                            ...
                            <div class="card">
                                <div class="card-body p-4">
                                    ...
                                    <img src="../assets/images/products/s1.jpg" alt=""
                                        class="rounded-4 w-100 object-fit-cover mb-4" height="160">
                                    <button class="btn btn-primary w-100 fw-normal py-8">Gift to Friend
                                        ($50.00)</button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    ...
                                                    <img src="../assets/images/svgs/icon-paypal.svg" alt=""
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    ...
                                                    <img src="../assets/images/svgs/icon-office-bag.svg"
                                                        alt="" class="img-fluid" width="24"
                                                        height="24">
                                                </div>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    ...
                                                    <img src="../assets/images/svgs/icon-master-card.svg"
                                                        alt="" class="img-fluid" width="24"
                                                        height="24">
                                                </div>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-7 pb-8">
                                            <div class="d-flex">
                                                <div
                                                    ...
                                                    <img src="../assets/images/svgs/icon-pie.svg" alt=""
                                                        class="img-fluid" width="24" height="24">
                                                </div>
                                                <div>
                                    ...
                                    <div class="position-relative">
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    class="p-8 bg-primary-subtle rounded-2 d-flex align-items-center justify-content-center me-6">
                                                    <img src="../assets/images/svgs/icon-map-pin.svg" alt=""
                                                        class="img-fluid" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    class="p-8 bg-info-subtle rounded-2 d-flex align-items-center justify-content-center me-6">
                                                    <img src="../assets/images/svgs/icon-database.svg"
                                                        alt="" class="img-fluid" width="24"
                                                        height="24">
                                                </div>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    class="p-8 bg-warning-subtle rounded-2 d-flex align-items-center justify-content-center me-6">
                                                    <img src="../assets/images/svgs/icon-phone.svg" alt=""
                                                        class="img-fluid" width="24" height="24">
                                                </div>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-4">
                                            <div class="d-flex">
                                                <div
                                                    class="p-8 bg-danger-subtle rounded-2 d-flex align-items-center justify-content-center me-6">
                                                    <img src="../assets/images/svgs/icon-screen-share.svg"
                                                        alt="" class="img-fluid" width="24"
                                                        height="24">
                                                </div>
                                                <div>
                                        ...
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex">
                                                <div
                                                    class="p-8 bg-success-subtle rounded-2 d-flex align-items-center justify-content-center me-6">
                                                    <img src="../assets/images/svgs/icon-mail.svg" alt=""
                                                        class="img-fluid" width="24" height="24">
                                                </div>
                                                <div>
                        ...
                        <div class="col-lg-4">
                            <div class="card w-100">
                                <div class="card-body">
                                    <h5 class="card-title fw-semibold mb-7">Recent Transactions</h5>
