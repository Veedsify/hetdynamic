                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Weather</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Weather</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                            ...
                            <div class="card text-bg-info">
                                <div class="card-body">
                                    <div class="text-center text-white">
                                        ...
                                        <div class="mt-4">
                                            <span class="display-5 text-white"><i
                                                    class="wi wi-day-rain-mix"></i></span>
                        ...
                        <div class="col-md-6">
                            <div class="card text-center overflow-hidden">
                                ...
                                <div class="card-footer text-primary text-bg-white">
                                    <h4 class="font-weight-medium text-primary fs-5">
                                        Lester, London
                                    </h4>
