                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Bordered</h4>
                            ...
                            <div class="card">
                                ...
                                <form class="form-horizontal r-separator">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText1"
                                                    class="col-3 text-end control-label col-form-label">First
                                                    Name</label>
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText2"
                                                    class="col-3 text-end control-label col-form-label">Last
                                                    Name</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputEmail1"
                                                    class="col-3 text-end control-label col-form-label">Email</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText3"
                                                    class="col-3 text-end control-label col-form-label">Contact
                                                    No</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                    ...
                                    <div class="card-body text-bg-light">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText4"
                                                    class="col-3 text-end control-label col-form-label">Company</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputSelect1"
                                                    class="col-3 text-end control-label col-form-label">Interested
                                                    In</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputSelect2"
                                                    class="col-3 text-end control-label col-form-label">Budget</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputGroupFile01"
                                                    class="col-3 text-end control-label col-form-label">Select
                                                    File</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText5"
                                                    class="col-3 text-end control-label col-form-label">About
                                                    Project</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                ...
                                <form class="form-horizontal r-separator">
                                            ...
                                            <div class="col-sm-12 col-lg-6">
                                                <div class="form-group row align-items-center mb-0">
                                                    <label for="inputEmail7"
                                                        class="col-3 text-end control-label col-form-label">Username</label>
                                                    <div class="col-9 border-start pb-2 pt-2">
                                                        <input type="email" class="form-control"
                                                            id="inputEmail7" placeholder="Username Here">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-lg-6">
                                                <div class="form-group row align-items-center mb-0">
                                                    <label for="inputText19"
                                                        class="col-3 text-end control-label col-form-label">Nick
                                                        Name</label>
                                                    <div class="col-9 border-start pb-2 pt-2">
                                                        <input type="text" class="form-control"
                                                            id="inputText19" placeholder="Nick Name Here">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-body text-bg-light">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-lg-6">
                                                <div class="form-group row align-items-center mb-0">
                                                    ...
                                                    <div class="col-9 border-start pt-2 pb-2">
                                                        <input type="email" class="form-control"
                                                            id="inputEmail2" placeholder="Email Here">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-lg-6">
                                                <div class="form-group row align-items-center mb-0">
                                                    <label for="inputText8"
                                                        class="col-3 text-end control-label col-form-label">Website</label>
                                                    <div class="col-9 border-start pt-2 pb-2">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-12 col-lg-6">
                                                <div class="form-group row align-items-center mb-0">
                                                    <label for="inputText10"
                                                        class="col-3 text-end control-label col-form-label">Bio</label>
                                                    <div class="col-9 border-start pt-2 pb-2">
                                                        <input type="text" class="form-control"
                                                            id="inputText10" placeholder="Bio Here">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="card">
                                ...
                                <form class="form-horizontal r-separator">
                                    <div class="card-body">
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText11"
                                                    class="col-3 text-end control-label col-form-label">Employee
                                                    Name</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText12"
                                                    class="col-3 text-end control-label col-form-label">Project
                                                    Name</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                                    <input type="text" class="form-control" id="inputText12"
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputDate1"
                                                    class="col-3 text-end control-label col-form-label">Date</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText13"
                                                    class="col-3 text-end control-label col-form-label">Rate Per
                                                    Hour</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                                    <input type="text" class="form-control" id="inputText13"
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputTime1"
                                                    class="col-3 text-end control-label col-form-label">Start
                                                    Time</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputTime2"
                                                    class="col-3 text-end control-label col-form-label">End
                                                    Time</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText14"
                                                    class="col-3 text-end control-label col-form-label">Notes</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                            ...
                            <div class="card">
                                ...
                                <form class="form-horizontal r-separator">
                                    <div class="card-body">
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText15"
                                                    class="col-3 text-end control-label col-form-label">Full
                                                    Name</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText16"
                                                    class="col-3 text-end control-label col-form-label">Title</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText17"
                                                    class="col-3 text-end control-label col-form-label">Company</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                                    <input type="text" class="form-control" id="inputText17"
                                                        placeholder="Company Name Here">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="inputText18"
                                                    class="col-3 text-end control-label col-form-label">Contact
                                                    No</label>
                                                <div class="col-9 border-start pb-2 pt-2">
                                                    <input type="text" class="form-control" id="inputText18"
                                                        placeholder="Contact No Here">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group mb-0">
                                            <div class="row align-items-center">
                                                <label for="customControlValidation2"
                                                    class="col-3 text-end control-label col-form-label">Existing
                                                    Customer</label>
                                                <div class="col-9 border-start pb-2 pt-2">
