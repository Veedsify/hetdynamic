                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="card w-100 bg-info-subtle overflow-hidden shadow-none">
                                <div class="card-body py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-sm-6">
                                            <h5 class="fw-semibold mb-9 fs-5">Welcome back Natalia!</h5>
                                            <p class="mb-9">
                            ...
                            <div class="card w-100 bg-secondary-subtle overflow-hidden shadow-none">
                                <div class="card-body py-3">
                                    <div class="row justify-content-between align-items-center">
                                        <div class="col-sm-6">
                                            <h5 class="fw-semibold mb-9 fs-5">Track your every Transaction Easily</h5>
                                            <p class="mb-9">
                                                Track and record your every income and expence easily to control your
                                                balance
                                            </p>
                                        ...
                                        <div class="col-sm-5">
                                            <div class="position-relative mb-n5 text-center">
                                                <img src="../assets/images/backgrounds/track-bg.png" alt=""
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <img src="../assets/images/backgrounds/website-under-construction.svg"
                                                alt="" class="img-fluid mb-4" width="200">
                                            <h5 class="fw-semibold fs-5 mb-2">Oops something went wrong!</h5>
                                            <p class="mb-3 px-xl-5">Trying again to bypasses these temporary error.
                                            </p>
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body text-center">
                                            <img src="../assets/images/products/empty-shopping-bag.gif"
                                                alt="" class="img-fluid mb-4" width="200">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    ...
                                    <div class="position-relative overflow-hidden d-inline-block">
                                        ...
                                        <span
                                            class="badge rounded-pill round-20 text-bg-danger fs-2 position-absolute top-0 end-0 d-flex align-items-center justify-content-center me-3 mt-2">1</span>
                                    </div>
