                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Horizontal Grid</h5>
                                    </div>
                                    <form action="#">
                                        <div class="form-body">
                                            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Grid With Row Label</h5>
                                    </div>
                                    <form action="#">
                                        <div class="form-body">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Grid With Label</h5>
                                    </div>
                                    <form action="#">
                                        <div class="form-body">
                                            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Centered Input</h5>
                                    </div>
                                    <form action="#">
                                        <div class="form-body">
                                            <div class="row">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Centered Input with Default label</h5>
                                    </div>
                                    <form action="#">
                                        <div class="form-body">
                                            <div class="row">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Grid With Inline Input Label</h5>
                                    </div>
                                    <form action="#">
                                        <div class="form-body">
                                            <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Multiple Input With Default Label</h5>
                                    </div>
                                    <form action="#">
                                        <div class="form-body">
                                            <label class="form-label">Label </label>
                    ...
                    <div class="row">
                        <div class="col-12">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Multiple Input With Inline Label</h5>
                                    </div>
                                    <form action="#">
                                        <div class="form-body">
