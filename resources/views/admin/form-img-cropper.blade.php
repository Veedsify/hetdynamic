...
<head>
    ...
    <link rel="stylesheet" href="../assets/libs/cropper/dist/cropper.min.css">
</head>
...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Image-Cropper</h4>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-9 mb-4 mb-lg-0">
                                            ...
                                            <div class="img-container">
                                                <img id="image"
                                                    src="../assets/images/backgrounds/cropper-img.jpg"
                                                    alt="Picture">
                                            </div>
                                        </div>
                                        <div class="col-lg-3">
                                            ...
                                            <div class="docs-data">
                                                ...
                                                <div class="input-group mb-6">
                                                    <span class="input-group-text">
                                                        <label for="dataWidth">Width</label>
                                                    </span>
                                                ...
                                                <div class="input-group mb-6">
                                                    <span class="input-group-text">
                                                        <label for="dataHeight">Height</label>
                                                    </span>
                                                ...
                                                <div class="input-group mb-6">
                                                    <span class="input-group-text">
                                                        <label for="dataRotate">Rotate</label>
                                                    </span>
                                                ...
                                                <div class="input-group mb-6">
                                                    <span class="input-group-text">
                                                        <label for="dataScaleX">ScaleX</label>
                                                    </span>
                                                ...
                                                <div class="input-group mb-6">
                                                    <span class="input-group-text">
                                                        <label for="dataScaleY">ScaleY</label>
                                                    </span>
                    ...
                    <div class="row mb-4">
                        <div class="col-lg-8 docs-buttons mb-4 mb-lg-0">
                            <div class="btn-group mb-2 me-6">
                                <button type="button" class="btn btn-primary" data-method="setDragMode"
                                    ...
                                    <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                        ...
                                        <i class="ti ti-arrows-move fs-5"></i>
                                    </span>
                                </button>
                                <button type="button" class="btn btn-primary" data-method="setDragMode"
                            ...
                            <div class="btn-group mb-2 me-6">
                                <button type="button" class="btn btn-primary" data-method="scaleX"
                                    ...
                                    <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                        ...
                                        <i class="ti ti-arrows-horizontal fs-5"></i>
                                    </span>
                                </button>
                                <button type="button" class="btn btn-primary" data-method="scaleY"
                                    ...
                                    <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                        ...
                                        <i class="ti ti-arrows-vertical fs-5"></i>
                                    </span>
                                </button>
                            </div>
                            <div class="btn-group mb-2 me-6">
                            ...
                            <div class="btn-group mb-2 me-6 btn-group-crop">
                            ...
                            <!-- /.modal -->
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="getData"
                                data-option="" data-bs-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                    title='$().cropper("getData")'>
                                    Get Data
                                </span>
                            </button>
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="setData"
                                data-bs-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                    title='$().cropper("setData", data)'>
                                    Set Data
                                </span>
                            </button>
                            <button type="button" class="btn btn-primary mb-6 me-6"
                                data-method="getContainerData" data-option="" data-bs-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                                    title='$().cropper("getContainerData")'>
                                    Get Container Data
                                </span>
                            </button>
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="getImageData"
                                data-option="" data-bs-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="getCanvasData"
                                data-option="" data-bs-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="setCanvasData"
                                data-bs-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="getCropBoxData"
                                data-option="" data-bs-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="setCropBoxData"
                                data-bs-target="#putData">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="moveTo"
                                data-option="0">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="zoomTo"
                                data-option="1">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="rotateTo"
                                data-option="180">
                                <span class="docs-tooltip" data-bs-toggle="tooltip" data-animation="false"
                            ...
                            <button type="button" class="btn btn-primary mb-6 me-6" data-method="scale"
                        ...
                        <!-- /.docs-buttons -->
                        <div class="col-lg-4 docs-toggles">
                            <div class="btn-group d-flex flex-nowrap mb-6" data-bs-toggle="buttons">
    ...
    <script src="../assets/js/plugins/cropper.init.js"></script>
</body>
