...
<body>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-xl-8">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title fw-semibold">Follow Artists</h5>
                                        ...
                                        <div class="hstack gap-9">
                                            <a href="#" class="text-center flex-shrink-0 ">
                                                <div class="border border-2 border-primary rounded-circle">
                                                    <img src="../assets/images/music/s1.jpg"
                                                        class="rounded-circle img-fluid m-1" alt="art"
                                                        width="55">
                                                </div>
                                            ...
                                            <a href="#" class="text-center flex-shrink-0 ">
                                                <div class="border border-2 border-primary rounded-circle">
                                                    <img src="../assets/images/music/s2.jpg"
                                                        class="rounded-circle img-fluid m-1" alt="art"
                                                        width="55">
                                                </div>
                                            ...
                                            <a href="#" class="text-center flex-shrink-0 ">
                                                <div class="border border-2 border-primary rounded-circle">
                                                    <img src="../assets/images/music/s3.jpg"
                                                        class="rounded-circle img-fluid m-1" alt="art"
                                                        width="55">
                                                </div>
                                            ...
                                            <a href="#" class="text-center flex-shrink-0 ">
                                                <div class="border border-2 border-white rounded-circle">
                                                    <img src="../assets/images/music/s4.jpg"
                                                        class="rounded-circle img-fluid m-1" alt="art"
                                                        width="55">
                                                </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title fw-semibold">Recently Played</h5>
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="card shadow-none border position-relative mb-md-0">
                                                <div class="overflow-hidden rounded">
                                                    <a href="javascript:void(0)">
                                                        <img src="../assets/images/music/album5.jpg"
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="card shadow-none border position-relative mb-md-0">
                                                <div class="overflow-hidden rounded">
                                                    <a href="javascript:void(0)">
                                                        <div class="hover-img">
                                                            <img src="../assets/images/music/album7.jpg"
                                                                class="rounded hover-img card-img" alt="art">
                                                        </div>
                                                    </a>
                                                </div>
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="card border shadow-none position-relative mb-0">
                                                <div class="overflow-hidden rounded">
                                                    <a href="javascript:void(0)">
                                                        <div class="hover-img">
                                                            <img src="../assets/images/music/album8.jpg"
                                                                class="rounded hover-img card-img" alt="art">
                                                        </div>
                                                    </a>
                                                </div>
                                                <div class="p-2 d-flex">
                                                    <div>
                                                        <h6 class="mt-2 mb-0 fw-semibold text-truncate">Badshah Party
                                                        </h6>
                            ...
                            <div class="row">
                                            ...
                                            <div class="row gx-3 mt-4">
                                                <div class="col-3">
                                                    <img src="../assets/images/profile/user-2.jpg"
                                                        class="rounded img-fluid" alt="art">
                                                </div>
                                                <div class="col-3">
                                ...
                                <div class="col-md-6">
                                    <div class="card">
                                        <div class="card-body p-4">
                                            <h5 class="card-title">Favourite Artists</h5>
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <div class="card-body">
                                    <h5 class="card-title fw-semibold">Recent Search</h5>
                                    ...
                                    <div class="card bg-primary-subtle shadow-none mb-0">
                                        <div class="card-body px-3 py-4">
                                            <div class="text-center">
                                                <div class="mplayer">
                                                    <div id="jp_container_N"
                                                        class="jp-video-270p jp-state-no-volume">
                                                        <div class="jp-type-playlist">
                                                            <div id="jplayer_N" class="jp-jplayer hide"></div>
                                                            <div class="jp-gui">
                                                                <div class="jp-interface">
                                                                    <img src="../assets/images/music/album3.jpg"
                                                                        class="rounded poster" alt="album"
                                                                        width="100">
                                                                    <h5 class="mt-3 mb-0 jp-title fw-semibold fs-5">
                                                                    </h5>
                                                                    ...
                                                                    <div class="jp-controls">
                                                                        <div>
                                                                            ...
                                                                            <a class="jp-repeat-off hide btn border-0 round-sm rounded-circle"
                                                                                title="repeat off">
                                                                                <i
                                                                                    class="ti ti-repeat fs-4 text-primary"></i>
                                                                            </a>
                                                                        </div>
                                                                        <div>
                                                                            <a
                                                                                class="jp-previous btn border-0 round-sm opacity-75 rounded-circle">
                                                                                <i
                                                                        ...
                                                                        <div>
                                                                            <a
                                                                                class="jp-next btn border-0 round-sm opacity-75 rounded-circle">
                                                                                <i
                                                                        ...
                                                                        <div>
                                                                            <a class="jp-shuffle btn border-0 round-sm opacity-75 rounded-circle"
                                                                                title="shuffle">
                                                                                <i
                                                                                    class="ti ti-arrows-shuffle-2 fs-4"></i>
                                                                            </a>
                                                                            <a class="jp-shuffle-off hide btn border-0 round-sm rounded-circle"
                                                                                title="shuffle off">
                                                                                <i
                                                                                    class="ti ti-arrows-shuffle-2 fs-4 text-primary"></i>
                                                                            </a>
                                                                        </div>
                                                                    </div>
                                                                    <div class="jp-progress hidden-xs">
                                                                        <div class="jp-seek-bar w-100">
                                                                            <div
                                                                                class="jp-play-bar play-progress w-0">
                                                                            </div>
                                                                            <div class="jp-current-time current-time">
                                                                            </div>
                                                                    ...
                                                                    <div>
                                                                        <a class="jp-mute " title="mute">
                                                                            <i
                                                                                class="ti ti-volume-3 text-muted fs-4"></i>
                                                                        </a>
                                                                        <a class="jp-unmute" title="unmute">
                                                                            <i
                                                                                class="ti ti-volume fs-4 text-primary"></i>
                                                                        </a>
                                                                    </div>
                                            ...
                                            <div
                                                class="d-flex align-items-center mt-3 p-3 bg-hover-light-black rounded border-bottom">
                                                <div class="position-relative d-flex align-items-center">
                                                    <a href="javascript:void(0)" class="stretched-link "></a>
                                                    <img src="../assets/images/music/album1.jpg" width="45"
                                                        class="rounded" alt="album">
                                                    <div class="ms-3">
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="m1">
                                                            <li>
                                                                <a class="dropdown-item" href="#">
                                                                    <i
                                                                        class="ti ti-share text-muted me-1 fs-4"></i>Share
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" href="#">
                                                                    <i
                                                                        class="ti ti-download text-muted me-1 fs-4"></i>Download
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item" href="#">
                                                                    <i
                                                                        class="ti ti-info-circle text-muted me-1 fs-4"></i>Get
                                                                    Song Info </a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                            ...
                                            <div
                                                class="d-flex align-items-center bg-hover-light-black rounded p-3 border-bottom">
                                                <div class="position-relative d-flex align-items-center">
                                                    <a href="javascript:void(0)" class="stretched-link "></a>
                                                    <img src="../assets/images/music/album2.jpg" width="45"
                                                        alt="album" class="rounded">
                                                    <div class="ms-3">
                                                ...
                                                <div class="ms-auto">
                                                    <div class="dropdown">
                                                        <a class="" href="javascript:void(0)" id="m2"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="ti ti-dots-vertical fs-4"></i>
                                                        </a>
                                            ...
                                            <div class="d-flex align-items-center p-3 bg-hover-light-black rounded">
                                                <div class="position-relative d-flex align-items-center">
                                                    <a href="javascript:void(0)" class="stretched-link "></a>
                                                    <img src="../assets/images/music/album4.jpg" width="45"
                                                        alt="album" class="rounded">
                                                    <div class="ms-3">
                                                        <h6 class="mb-0 fw-semibold text-truncate w-75">RedTape Anthem
                                                        </h6>
                                                ...
                                                <div class="ms-auto">
                                                    <div class="dropdown">
                                                        <a class="" href="javascript:void(0)" id="m3"
                                                            data-bs-toggle="dropdown" aria-expanded="false">
                                                            <i class="ti ti-dots-vertical fs-4"></i>
                                                        </a>
                                            ...
                                            <div
                                                class="d-flex align-items-center p-3 bg-hover-light-black rounded border-bottom">
                                                <div class="position-relative d-flex align-items-center">
                                                    <a href="javascript:void(0)" class="stretched-link "></a>
                                                    <img src="../assets/images/music/album1.jpg" width="45"
                                                        class="rounded" alt="album">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-xl-4">
                            <div class="card">
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h5 class="card-title fw-semibold">Top 10 from this week</h5>
                                            <p class="card-subtitle">Based on your preferences</p>
                                        </div>
                                        <div class="ms-auto">
                                            <div class="dropdown">
                                                <a class="" href="javascript:void(0)" id="t1"
                                                    data-bs-toggle="dropdown" aria-expanded="false">
                                                    <i class="ti ti-dots-vertical fs-4"></i>
                                                </a>
                                                <ul class="dropdown-menu" aria-labelledby="t1">
                                                    ...
                                                    <li>
                                                        <a class="dropdown-item" href="#">
                                                            <i class="ti ti-info-circle text-muted me-1 fs-4"></i>Get
                                                            Song Info </a>
                                                    </li>
                                                </ul>
                                            </div>
                                    ...
                                    <div class="mt-4 overflow-auto gap-4 h-450" data-simplebar="">
                                        <a href="javascript:void(0)" class="mb-4 d-block">
                                            <img src="../assets/images/music/top10-1.jpg" class="img-fluid rounded"
                                                alt="album">
                                        </a>
                                        <a href="javascript:void(0)" class="mb-4 d-block">
                                            <img src="../assets/images/music/top10-2.jpg" class="img-fluid rounded"
                                                alt="album">
                                        </a>
                                        <a href="javascript:void(0)" class="d-block">
                                            <img src="../assets/images/music/top10-3.jpg" class="img-fluid rounded"
                                                alt="album">
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card">
                                <div class="card-body p-4">
                                    <div class="d-flex align-items-center">
                                        <div>
                                            <h5 class="card-title fw-semibold">Top Playlist</h5>
                                    ...
                                    <div class="overflow-auto card mt-4 mb-0 shadow-none border h-450"
                                        data-simplebar="">
                                        <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                                            ...
                                            <img src="../assets/images/music/album1.jpg" alt="top-1"
                                                width="40" class="rounded ms-3">
                                            <div class="ms-3">
                                        ...
                                        <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                                            ...
                                            <img src="../assets/images/music/album2.jpg" alt="top-1"
                                                width="40" class="rounded ms-3">
                                            <div class="ms-3">
                                        ...
                                        <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                                            ...
                                            <img src="../assets/images/music/album3.jpg" alt="top-1"
                                                width="40" class="rounded ms-3">
                                            <div class="ms-3">
                                        ...
                                        <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                                            ...
                                            <img src="../assets/images/music/album4.jpg" alt="top-1"
                                                width="40" class="rounded ms-3">
                                            <div class="ms-3">
                                        ...
                                        <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                                            ...
                                            <img src="../assets/images/music/album5.jpg" alt="top-1"
                                                width="40" class="rounded ms-3">
                                            <div class="ms-3">
                                        ...
                                        <div class="hstack p-3 bg-hover-light-black position-relative border-bottom">
                                            ...
                                            <img src="../assets/images/music/album6.jpg" alt="top-1"
                                                width="40" class="rounded ms-3">
                                            <div class="ms-3">
                                                <h6 class="mb-0">N95</h6>
                                                <span class="fs-3">Roddy Ricch</span>
                                        ...
                                        <div class="hstack p-3 bg-hover-light-black position-relative">
                                            ...
                                            <img src="../assets/images/music/album7.jpg" alt="top-1"
                                                width="40" class="rounded ms-3">
                                            <div class="ms-3">
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="card">
                                <div class="card-body p-4">
                                    <h5 class="card-title fw-semibold">Most Popular this week</h5>
                                    <p class="card-subtitle">Based on your preferences</p>
                                    <div class="mt-4 card p-3 rounded shadow-none border">
                                        <div class="d-flex align-items-center">
                                            <div class="position-relative">
                                                <img src="../assets/images/music/album1.jpg" class="rounded"
                                                    alt="album" width="97">
                                                <div
                                    ...
                                    <div class="mt-4 card p-3 rounded shadow-none border">
                                        <div class="d-flex align-items-center">
                                            <div class="position-relative">
                                                <img src="../assets/images/music/album2.jpg" class="rounded"
                                                    alt="album" width="97">
                                                <div
                                                    class="card-img-overlay d-flex align-items-center justify-content-center">
                                                    <button class="btn btn-primary rounded-circle round p-0">
                                    ...
                                    <div class="mt-4 card mb-0 p-3 rounded shadow-none border">
                                        <div class="d-flex align-items-center">
                                            <div class="position-relative">
                                                <img src="../assets/images/music/album4.jpg" class="rounded"
                                                    alt="album" width="97">
                                                <div
                                                    class="card-img-overlay d-flex align-items-center justify-content-center">
                                                    <button class="btn btn-primary rounded-circle round p-0">
    ...
    <script src="../assets/js/jplayer/jplayer.js"></script>
    <script src="../assets/libs/jplayer/dist/jplayer/jquery.jplayer.min.js"></script>
    <script src="../assets/libs/jplayer/dist/add-on/jplayer.playlist.min.js"></script>
</body>
