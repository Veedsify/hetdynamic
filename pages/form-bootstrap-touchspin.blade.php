...
<head>
    ...
    <link rel="stylesheet" href="../assets/libs/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css">
</head>
...
<body>
        ...
        <div class="page-wrapper">
            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Touchspin</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Touchspin</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                    ...
                    <p>
                        We have used thirdparty plugin js of bootstrap touchspin and you
                        can find the official website here:
                        <a href="https://www.virtuosoft.eu/code/bootstrap-touchspin/">Bootstrap Touchspin</a>
                    </p>
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <!-- start Normal Touchspin -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Normal Touchspin</h5>
                                    </div>
                                    <form class="mt-3">
                            ...
                            <!-- end Normal Touchspin -->
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <!-- start Postfix Touchspin -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Postfix Touchspin</h5>
                                    </div>
                                    <form class="mt-3">
                            ...
                            <!-- end Postfix Touchspin -->
                        </div>
                        <div class="col-lg-4 col-md-6">
                            <!-- start Prefix Touchspin -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Prefix Touchspin</h5>
                                    </div>
                                    <form class="mt-3">
                            ...
                            <!-- end Prefix Touchspin -->
                        </div>
                        <div class="col-lg-6">
                            <!-- start Vertical button alignment -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Vertical button alignment</h5>
                                    </div>
                                    <form class="mt-3">
                                        <div class="form-group">
                                            <input id="demo_vertical" type="text" value=""
                                                name="demo_vertical">
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <!-- end Vertical button alignment -->
                        </div>
                        <div class="col-lg-6">
                            <!-- start Vertical buttons with custom icons -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Vertical buttons with custom icons</h5>
                                    </div>
                                    <form class="mt-3">
                                        <div class="form-group">
                                            <input id="demo_vertical2" type="text" value=""
                                                name="demo_vertical2">
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <!-- end Vertical buttons with custom icons -->
                        </div>
                        <div class="col-lg-6">
                            <!-- start Touchspin With Button (small) -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Touchspin With Link Button</h5>
                                    </div>
                                    <form class="mt-3">
                                        <div class="form-group">
                                            <div class="input-group input-group-sm">
                                                <input id="demo4" type="text" value=""
                                                    name="demo4" class="input-sm">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <!-- end Touchspin With Button (small) -->
                        </div>
                        <div class="col-lg-6">
                            <!-- start Prefix Touchspin (large) -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Prefix Touchspin (large)</h5>
                                    </div>
                                    <form class="form-horizontal mt-3">
                                        <div class="form-group">
                                            <div class="input-group input-group-sm">
                                                <input id="demo4_2" type="text" value=""
                                                    name="demo4_2" class="form-control input-sm">
                                            </div>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            <!-- end Prefix Touchspin (large) -->
                        </div>
                        <div class="col-lg-6">
                            <!-- start Button Group -->
                            <div class="card">
                                    ...
                                    <form class="form-horizontal mt-3">
                                        <div class="form-group">
                                            <div class="input-group">
                                                ...
                                                <div class="btn-group">
                                                    <button type="button"
                                                        class="btn bg-primary-subtle text-primary rounded-0">
                                                        Action
                                                    </button>
                                                    <button type="button"
                                                        class="btn bg-primary-subtle text-primary rounded-start-0 dropdown-toggle rounded-end dropdown-toggle-split"
                        ...
                        <div class="col-lg-6">
                            <!-- start Change Button Class -->
                            <div class="card">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Change Button Class</h5>
                                    </div>
                                    <form class="form-horizontal mt-3">
                                        <div class="form-group">
    ...
    <script src="../assets/js/forms/form-bootstrap-touchspin.init.js"></script>
</body>
