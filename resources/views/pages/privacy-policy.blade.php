...
@section('content')
    ...
    <div class="page-wrapper">
        ...
        <section class="page-header">
            <div class="page-header-bg" style="background-image: url({{ asset($privacyBanner->privacy_banner_image) }})">
            </div>
            <div class="container">
                <div class="page-header__inner">
                    <h2>{{ $privacyBanner->privacy_banner_title }}</h2>
              ...
              <div class="row">
                <div class="section-title text-left">
                    <div class="section-title__tagline-box">
                        <span class="section-title__tagline">{{ $privacyContent->privacy_title }}</span>
                        <div class="section-title__border-box"></div>
                    </div>
                </div>
                <p class="fw-semibold text-dark fs-6 " style="letter-spacing: .7px">
                    {{ $privacyContent->privacy_description }}
                </p>
