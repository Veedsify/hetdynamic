                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Striped-Row</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Striped-Row</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                    ...
                    <div class="card">
                        ...
                        <div>
                            ...
                            <div class="row p-3 mx-0 bg-light-subtle">
                                <div class="col-sm-3">
                                    <div class="b-label">
                                        <label for="pi-fname" class="control-label col-form-label">First
                                            Name</label>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="pi-fname"
                            ...
                            <div class="row p-3 mx-0">
                                <div class="col-sm-3">
                                    <div class="b-label">
                                        <label for="inputEmail4" class="control-label col-form-label">Last
                                            Name</label>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row p-3 mx-0 bg-light-subtle">
                                <div class="col-sm-3">
                                    <div class="b-label">
                                        <label for="inputEmail5" class="control-label col-form-label">Email</label>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row p-3 mx-0">
                                <div class="col-sm-3">
                                    <div class="b-label">
                                        <label for="inputEmail6" class="control-label col-form-label">Contact
                                            No</label>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                        ...
                        <div>
                            ...
                            <div class="row p-3 mx-0 bg-light-subtle">
                                <div class="col-sm-3">
                                    <div class="b-label">
                                        <label for="require2" class="control-label col-form-label">Company</label>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="require2"
                            ...
                            <div class="row p-3 mx-0">
                                <div class="col-sm-3">
                                    <div class="b-label">
                                        <label for="inputEmail3" class="control-label col-form-label">Interested
                                            In</label>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row p-3 mx-0">
                                <div class="col-sm-3">
                                    <div class="b-label">
                                        <label for="inputEmail3" class="control-label col-form-label">Select
                                            File</label>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                            ...
                            <div class="row p-3 mx-0 bg-light-subtle">
                                <div class="col-sm-3">
                                    <div class="b-label">
                                        <label for="inputEmail3" class="control-label col-form-label">About
                                            Project</label>
                                    </div>
                                </div>
                                <div class="col-sm-9">
                                    ...
                                    <div>
                                            ...
                                            <div class="col-9">
                                                <div class="input-group">
                                                    ...
                                                    <input type="date" class="form-control"
                                                        placeholder="Date here" aria-label="Username"
                                        ...
                                        <div class="mx-0 p-3 row">
                                            <div class="col-3">
                                                <div class="b-label">
                                                    <label for="inputEmail3"
                                                        class="control-label col-form-label">Rate Per Hour</label>
                                                </div>
                                            </div>
                                            <div class="col-9">
                                                <div class="input-group">
                                ...
                                <form class="border-top">
                                    <div>
                                        <div class="p-3 mx-0 bg-light-subtle row">
                                            <div class="col-3">
                                                <div class="b-label">
                                                    <label for="er-email" class="control-label col-form-label">Full
                                                        Name</label>
                                                </div>
                                            </div>
                                            <div class="col-9">
                                                <input type="text" class="form-control" id="er-email"
                                        ...
                                        <div class="p-3 mx-0 row">
                                            ...
                                            <div class="col-9">
                                                <input type="text" class="form-control" id="er-title"
                                        ...
                                        <div class="p-3 mx-0 bg-light-subtle row">
                                            <div class="col-3">
                                                <div class="b-label">
                                                    <label for="er-company"
                                                        class="control-label col-form-label">Company</label>
                                                </div>
                                            </div>
                                            <div class="col-9">
                                                <input type="text" class="form-control" id="er-company"
                                                    placeholder="Company Name Here">
                                            </div>
                                        </div>
                                        <div class="p-3 mx-0 row">
                                            ...
                                            <div class="col-9">
                                                <input type="email" class="form-control" id="er-email2"
                                                    placeholder="Email Here">
                                            </div>
                                        </div>
                                        <div class="p-3 mx-0 bg-light-subtle row">
                                            ...
                                            <div class="col-9">
                                                <input type="text" class="form-control" id="er-cno"
                                                    placeholder="Contact No Here">
                                            </div>
                                        </div>
                                        <div class="p-3 mx-0 row">
