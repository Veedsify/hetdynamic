                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <form novalidate="">
                                        ...
                                        <div class="mb-3 form-group">
                                            <label class="form-label">Input with Icon <span
                                                    class="text-danger">*</span></label>
                                            <div class="controls">
                                        ...
                                        <div class="mb-3 form-group">
                                            <label class="form-label">Only Numbers <span
                                                    class="text-danger">*</span></label>
                                            <div class="input-group">
                                                <span class="input-group-text"><i
                                                        class="ti ti-currency-dollar fs-5"></i></span>
                                                <input type="number" name="onlyNum" class="form-control"
                                                    required=""
                                                    data-validation-required-message="This field is required">
                                        ...
                                        <div class="mb-3 form-group">
                                            <label class="form-label">Maximum Number <span
                                                    class="text-danger">*</span></label>
                                        ...
                                        <div class="mb-3 form-group">
                                            <label class="form-label">Minimum Number <span
                                                    class="text-danger">*</span></label>
                                            <div class="controls">
                                                <input type="text" name="minNum" class="form-control"
                                                    required=""
                                                    data-validation-required-message="This field is required"
                                                    min="10">
                                            </div>
                                        ...
                                        <div class="mb-3 form-group">
                                            <label class="form-label">Enter URL <span
                                                    class="text-danger">*</span></label>
                                            <div class="controls">
                                        ...
                                        <div class="mb-3 form-group">
                                            <label class="form-label">Enter Date <span
                                                    class="text-danger">*</span></label>
                                            <div class="controls">
                                                <input type="text" class="form-control"
                                        ...
                                        <div class="mb-3 form-group">
                                            <label class="form-label">Basic Select <span
                                                    class="text-danger">*</span></label>
                                            <div class="controls">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3 form-group">
                                                    <label class="form-label">Checkbox <span
                                                            class="text-danger">*</span></label>
                                                    <div class="controls">
                                                        <div class="form-check">
                                                            <input type="checkbox" required="" value="single"
                                                                class="form-check-input" id="customCheck1">
                                                            <label class="form-check-label" for="customCheck1">Check
                                                        ...
                                                        <fieldset>
                                                            <div class="form-check py-2">
                                                                <input type="checkbox" value="y"
                                                                    name="styled_checkbox" class="form-check-input"
                                                                    id="customCheck3">
                                                                <label class="form-check-label" for="customCheck3">I
                                                                    am unchecked too</label>
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="mb-3 form-group">
                                                    <label class="form-label">Select Max 2 Checkbox<span
                                                            class="text-danger">*</span></label>
                                                    <div class="controls">
                                                        <fieldset>
                                                            <div class="form-check py-2">
                                                        ...
                                                        <fieldset>
                                                            <div class="form-check py-2">
                                                                ...
                                                                <label class="form-check-label" for="customCheck5">I
                                                                    am unchecked too</label>
                                                            </div>
                                                        </fieldset>
                                                        <fieldset>
                                                            <div class="form-check py-2">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="customCheck6">You can check me</label>
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    ...
                                                    <div class="controls">
                                                        <fieldset>
                                                            <div class="form-check py-2">
                                                                ...
                                                                <label class="form-check-label" for="customCheck7">I
                                                                    am unchecked checkbox</label>
                                                            </div>
                                                        </fieldset>
                                                        <fieldset>
                                                            <div class="form-check py-2">
                                                                ...
                                                                <label class="form-check-label" for="customCheck8">I
                                                                    am unchecked checkbox too</label>
                                                            </div>
                                                        </fieldset>
                                                        <fieldset>
                                                            <div class="form-check py-2">
                                                                ...
                                                                <label class="form-check-label"
                                                                    for="customCheck9">You can check me</label>
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                    <small>Select any 2 options</small>
                                                    ...
                                                    <fieldset class="controls">
                                                        <div class="form-check py-2">
                                                            <input type="radio" value="1"
                                                                ...
                                                                id="styled_radio1" class="form-check-input">
                                                            <label class="form-check-label"
                                                                for="styled_radio1">Check me</label>
                                                        </div>
                                                    </fieldset>
                                                    <fieldset>
                                                        <div class="form-check py-2">
                                                            <input type="radio" value="2"
                                                                name="styled_radio" id="styled_radio2"
                                                                class="form-check-input">
                                                            <label class="form-check-label" for="styled_radio2">or
                                                                me</label>
                                                        </div>
                                                    </fieldset>
                                                </div>
                                                        ...
                                                        <fieldset>
                                                            <div class="form-check py-2">
                                                                <input type="radio" value="Yes"
                                                                    name="styled_inline_radio" required=""
                                                                    id="styled_radio_inline1"
                                                                    class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="styled_radio_inline1">Check me</label>
                                                            </div>
                                                        </fieldset>
                                                        <fieldset>
                                                            <div class="form-check py-2">
                                                                <input type="radio" value="No"
                                                                    ...
                                                                    id="styled_radio_inline2"
                                                                    class="form-check-input">
                                                                <label class="form-check-label"
                                                                    for="styled_radio_inline2">or me</label>
                                                            </div>
                                                        </fieldset>
                                                    </div>
                                                </div>
