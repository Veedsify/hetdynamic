                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Pagination</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Default Pagination</h5>
                                    </div>
                        ...
                        <div class="col-lg-4 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Pagination with Icon</h5>
                                    </div>
                                    <nav aria-label="Page navigation example">
                                        <ul class="pagination">
                                            <li class="page-item">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Large Pagination</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Small Pagination</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Fancy larger or smaller pagination? Add
                                        <mark><code>.pagination-lg</code></mark> or
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Center Alignment Pagination</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Right Alignment Pagination</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Change the alignment of pagination components with flexbox
                                        utilities.
