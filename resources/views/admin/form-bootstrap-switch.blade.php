...
<body>
                ...
                <div class="container-fluid">
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Form Input Grid</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Form Input Grid</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                    ...
                    <div class="row">
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <!-- start Bootstrap 5 Default Switch -->
                            ...
                            <!-- end Bootstrap 5 Default Switch -->
                        </div>

                        <div class="col-lg-6 d-flex align-items-stretch">
                            <!-- start Bootstrap Switch -  Size -->
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="card-title mb-0">Bootstrap Switch - Size</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Just add
                                        <mark><code>data-size="Size"</code></mark> attribute to
                                        the
                                        <mark><code>&lt;input type="checkbox"...&gt;</code></mark>. Size values:
                                        <mark><code>mini, small, normal, large</code></mark>.
                                    </p>
                                    <div class="mb-4 bt-switch d-flex flex-wrap gap-6">
                            ...
                            <!-- end Bootstrap Switch -  Size -->
                        </div>

                        <div class="col-lg-6 d-flex align-items-stretch">
                            <!-- start Bootstrap switch - Disabled/Readonly -->
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="card-title mb-0">
                                    ...
                                    <p class="mb-3 card-subtitle">
                                        Just add <mark><code>disabled</code></mark> or
                                        <mark><code>readonly</code></mark> attribute to the
                                        <mark><code>&lt;input type="checkbox"...&gt;</code></mark>.
                                    </p>
                                    <div class="bt-switch d-flex flex-wrap gap-6">
                                        <input type="checkbox" checked="" disabled=""
                                            data-on-color="primary" data-off-color="info">
                                        <input type="checkbox" readonly="" data-on-color="info"
                                            data-off-color="success">
                                    </div>
                                </div>
                            </div>
                            <!-- end Bootstrap switch - Disabled/Readonly -->
                        </div>
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <!-- start Bootstrap Switch -  Colors -->
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="card-title mb-0">Bootstrap Switch - Colors</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Just add
                                        <mark><code>data-on-color="Color"</code></mark> &amp;
                                        <mark><code>data-off-color="Color"</code></mark> to the
                                        <mark><code>&lt;input type="checkbox"...&gt;</code></mark>. Color values:
                                        <mark><code>primary, info, success, warning, danger,
                                                default</code></mark>.
                                    </p>
                                    <div class="mb-4 bt-switch d-flex gap-6 flex-wrap">
                                        <input type="checkbox" checked="" data-on-color="primary"
                                            data-off-color="info">
                                        <input type="checkbox" checked="" data-on-color="info"
                                            data-off-color="success">
                                        <input type="checkbox" checked="" data-on-color="success"
                                            data-off-color="warning">
                                        <input type="checkbox" checked="" data-on-color="warning"
                                            data-off-color="danger">
                                        <input type="checkbox" checked="" data-on-color="danger"
                            ...
                            <!-- end Bootstrap Switch -  Colors -->
                        </div>
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <!-- start Bootstrap switch - Radio Buttons -->
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="card-title mb-0">
                                    ...
                                    <p class="mb-3 card-subtitle">
                                        Just add class <mark><code>radio-switch</code></mark> to
                                        the <mark><code>&lt;input type="radio"...&gt;</code></mark>. If you want to
                                        change the class name,
                                        you have to
                                        change jquery according to that.
                                    </p>
                                    <div class="bt-switch d-flex gap-6 flex-column">
                                        <div class="mb-1">
                                            <label class="form-label me-6" for="option1">Option 1</label>
                                            <input id="option1" type="radio" name="radiobt" value="option1"
                                                class="radio-switch">
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label me-6" for="option2">Option 2</label>
                                            <input id="option2" type="radio" name="radiobt" value="option2"
                                                class="radio-switch">
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label me-6" for="option3">Option 3</label>
                                            <input id="option3" type="radio" name="radiobt" value="option3"
                                                class="radio-switch">
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <!-- end Bootstrap switch - Radio Buttons -->
                        </div>
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <!-- start Bootstrap switch - With Text -->
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="card-title mb-0">
                                    ...
                                    <p class="mb-3 card-subtitle">
                                        Just add
                                        <mark><code>data-on-text="Text"</code></mark> &amp;
                                        <mark><code>data-off-text="Text"</code></mark> to the
                                        <mark><code>&lt;input type="checkbox"...&gt;</code></mark>.
                                    </p>
                                    <div class="bt-switch d-flex flex-wrap gap-6">
                                        <input type="checkbox" checked="" data-on-color="success"
                            ...
                            <!-- end Bootstrap switch - With Text -->
                        </div>
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <!-- start Bootstrap switch - With Long Text -->
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="card-title mb-0">
                                    ...
                                    <p class="mb-3 card-subtitle">
                                        Just add
                                        <mark><code>data-on-text="Long Text"</code></mark> &amp;
                                        <mark><code>data-off-text="Long Text"</code></mark> to the
                                        <mark><code>&lt;input type="checkbox"...&gt;</code></mark>.
                                    </p>
                                    <div class="bt-switch d-flex flex-wrap gap-6">
                                        <input type="checkbox" checked="" data-on-color="danger"
                                            data-off-color="warning" data-on-text="Explicit"
                                            data-off-text="Implicit">
                                        <input type="checkbox" checked="" data-on-color="warning"
                                            data-off-color="danger" data-on-text="Enabled"
                                            data-off-text="Disabled">
                                    </div>
                                </div>
                            </div>
                            <!-- end Bootstrap switch - With Long Text -->
                        </div>
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <!-- start Bootstrap switch - With Label Text -->
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="card-title mb-0">
                                    ...
                                    <p class="mb-3 card-subtitle">
                                        Just add <mark><code>data-on-text="Text"</code></mark> or
                                        <mark><code>data-off-text="Text"</code></mark> to the
                                        <mark><code>&lt;input type="checkbox"...&gt;</code></mark>.
                                    </p>
                                    <div class="bt-switch d-flex flex-wrap gap-6">
                                        <input type="checkbox" checked="" data-on-color="danger"
                                            data-off-color="success" data-on-text="Radio">
                                        <input type="checkbox" checked="" data-on-color="success"
                                            data-off-color="danger" data-off-text="Waves">
                                    </div>
                                </div>
                            </div>
                            <!-- end Bootstrap switch - With Label Text -->
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script src="../assets/js/forms/bootstrap-switch.js"></script>
</body>
