                ...
                <div class="container-fluid">
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="add-task-title modal-title" id="addTaskModalTitleLabel1">Add Task
                                    </h5>
                                    <h5 class="edit-task-title modal-title" id="addTaskModalTitleLabel2">Edit Task
                                    </h5>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="task-title mb-4 d-flex">
                                                                            <input id="kanban-title" type="text"
                                                                                placeholder="Task"
                                ...
                                <div class="modal-footer justify-content-start">
                                    <div class="d-flex gap-6">
                                        <button data-btn-action="addTask" class="btn add-tsk btn-primary">Add
                                            Task</button>
                                        <button data-btn-action="editTask"
                                            class="btn edit-tsk btn-success">Save</button>
                                        <button
                                            class="btn bg-danger-subtle text-danger d-flex align-items-center gap-1"
                    ...
                    <div class="modal fade" id="addListModal" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title add-list-title" id="addListModalTitleLabel1">Add List
                                    </h5>
                                    <h5 class="modal-title edit-list-title" id="addListModalTitleLabel2">Edit List
                                    </h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                        aria-label="Close"></button>
                                </div>
                    ...
                    <div class="modal fade" id="deleteConformation" tabindex="-1" role="dialog"
                        ...
                        <div class="modal-dialog modal-dialog-centered" role="document">
                            <div class="modal-content" id="deleteConformationLabel">
                                ...
                                <div class="modal-body">
                                    <p class="mb-0">If you delete the task it will be gone forever. Are you sure you
                                        want to
                                        proceed?</p>
                                </div>
                        ...
                        <div class="col-lg-12 layout-spacing pb-3">
                            <div data-simplebar="">
                                <div class="task-list-section">
                                    <div data-item="item-todo" class="task-list-container" data-action="sorting">
                                        <div class="connect-sorting connect-sorting-todo">
                                            <div class="task-container-header">
                                                <h6 class="item-head mb-0 fs-4 fw-semibold" data-item-title="Todo">
                                                    Todo</h6>
                                                <div class="hstack gap-2">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end"
                                                            ...
                                                            <a class="dropdown-item list-edit"
                                                                href="javascript:void(0);">Edit</a>
                                                            <a class="dropdown-item list-delete"
                                                                href="javascript:void(0);">Delete</a>
                                                            <a class="dropdown-item list-clear-all"
                                                ...
                                                <div data-draggable="true" class="card img-task">
                                                    <div class="card-body">
                                                        <div class="task-header">
                                                            <div>
                                                                <h4 class=""
                                                                    data-item-title="This is first task">
                                                                    This is first task</h4>
                                                            </div>
                                                            <div class="dropdown">
                                                                <a class="dropdown-toggle" href="#"
                                                                    role="button" id="dropdownMenuLink-1"
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-end"
                                                                    ...
                                                                    <a class="dropdown-item kanban-item-edit cursor-pointer d-flex align-items-center gap-1"
                                                                        href="javascript:void(0);"><i
                                                                            class="ti ti-pencil fs-5"></i>Edit</a>
                                                                    <a class="dropdown-item kanban-item-delete cursor-pointer d-flex align-items-center gap-1"
                                                                        href="javascript:void(0);"><i
                                                                            class="ti ti-trash fs-5"></i>Delete</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="task-content p-0">
                                                            <img src="../assets/images/backgrounds/kanban-img-1.jpg"
                                                                class="img-fluid" alt="scrumboard">
                                                        </div>
                                                        <div class="task-body">
                                                            <div class="task-bottom">
                                                                <div class="tb-section-1">
                                                                    <span class="hstack gap-2 fs-2"
                                                                        data-item-date="24 July"><i
                                                                            class="ti ti-calendar fs-5"></i> 24 July
                                                                    </span>
                                                                </div>
                                                                <div class="tb-section-2">
                                                                    <span
                                                                        class="badge rounded-pill text-bg-success fs-1">Design</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="task-body">
                                                            <div class="task-bottom">
                                                                ...
                                                                <div class="tb-section-2">
                                                                    <span
                                                                        class="badge rounded-pill text-bg-warning fs-1">Development</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="task-body">
                                                            <div class="task-bottom">
                                                                ...
                                                                <div class="tb-section-2">
                                                                    <span
                                                                        class="badge rounded-pill text-bg-primary fs-1">Mobile</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="connect-sorting connect-sorting-inprogress">
                                            <div class="task-container-header">
                                                <h6 class="item-head mb-0 fs-4 fw-semibold"
                                                    data-item-title="In Progress">In Progress</h6>
                                                <div class="hstack gap-2">
                                                    <div class="dropdown">
                                                        <a class="dropdown-toggle" href="#" role="button"
                                                            id="dropdownMenuLink-1" data-bs-toggle="dropdown"
                                                ...
                                                <div data-draggable="true" class="card img-task">
                                                    <div class="card-body">
                                                        <div class="task-header">
                                                            <div>
                                                                <h4 class=""
                                                                    data-item-title="Battle with fire">
                                                                    Battle with fire</h4>
                                                            </div>
                                                            <div class="dropdown">
                                                                <a class="dropdown-toggle" href="#"
                                                        ...
                                                        <div class="task-content p-0">
                                                            <img src="../assets/images/backgrounds/kanban-img-2.jpg"
                                                                class="img-fluid" alt="scrumboard">
                                                        </div>
                                                        <div class="task-body">
                                                            <div class="task-bottom">
                                    ...
                                    <div data-item="item-pending" class="task-list-container"
                                        data-action="sorting">
                                        <div class="connect-sorting connect-sorting-pending">
                                            <div class="task-container-header">
                                                <h6 class="item-head mb-0 fs-4 fw-semibold"
                                                    data-item-title="Pending">Pending</h6>
                                                <div class="hstack gap-2">
                                                    <div class="dropdown">
                                                        <a class="dropdown-toggle" href="#" role="button"
                                                            id="dropdownMenuLink-1" data-bs-toggle="dropdown"
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="task-content">
                                                            <p class="mb-0"
                                                                ...
                                                                represent different user groups and
                                                                their
                                                        ...
                                                        <div class="task-body">
                                                            <div class="task-bottom">
                                                                ...
                                                                <div class="tb-section-2">
                                                                    <span
                                                                        class="badge rounded-pill text-bg-warning fs-1">UX
                                                                        stage</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div data-draggable="true" class="card img-task">
                                                    <div class="card-body">
                                                        <div class="task-header">
                                                            <div>
                                                                <h4 class=""
                                                                    data-item-title="Redesign overview">
                                                        ...
                                                        <div class="task-content p-0">
                                                            <img src="../assets/images/backgrounds/my-card.jpg"
                                                                class="img-fluid" alt="scrumboard">
                                                        </div>
                                                        <div class="task-body">
                                                            <div class="task-bottom">
                                    ...
                                    <div data-item="item-pending" class="task-list-container"
                                        ...
                                        <div class="connect-sorting connect-sorting-done">
                                            <div class="task-container-header">
                                                <h6 class="item-head mb-0 fs-4 fw-semibold" data-item-title="Done">
                                                    Done</h6>
                                                <div class="hstack gap-2">
                                                    <div class="dropdown">
                                                        <a class="dropdown-toggle" href="#" role="button"
                                                ...
                                                <div data-draggable="true" class="card img-task">
                                                    <div class="card-body">
                                                        <div class="task-header">
                                                            <div>
                                                                <h4 class=""
                                                                    data-item-title="Usability testing">
                                                        ...
                                                        <div class="task-content p-0">
                                                            <img src="../assets/images/backgrounds/weatherbg.jpg"
                                                                class="img-fluid" alt="scrumboard">
                                                        </div>
                                                        <div class="task-body">
                                                            <div class="task-bottom">
                                                                ...
                                                                <div class="tb-section-2">
                                                                    <span
                                                                        class="badge rounded-pill text-bg-info fs-1">Research</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="task-body">
                                                            <div class="task-bottom">
                                                                ...
                                                                <div class="tb-section-2">
                                                                    <span
                                                                        class="badge rounded-pill text-bg-danger fs-1">Data
                                                                        science</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="task-body">
                                                            <div class="task-bottom">
                                                                ...
                                                                <div class="tb-section-2">
                                                                    <span
                                                                        class="badge rounded-pill text-bg-primary fs-1">Branding</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="task-content">
                                                            <p class="mb-0"
                                                                ...
                                                                research competitors and identify weakness and strengths
                                                                each of them. comparing their
