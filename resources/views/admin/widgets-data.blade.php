            ...
            <div class="body-wrapper">
                <div class="container-fluid">
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Widgets-Data</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Widgets-Data</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                                ...
                                <div class="card-body">
                                    <div class="d-flex no-block align-items-center mb-3">
                                        <span class="d-flex align-items-center"><i
                                                class="ti ti-calendar me-1 fs-5"></i> 20 May 2023</span>
                                        <div class="ms-auto">
                        ...
                        <div class="col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="d-flex no-block align-items-center mb-3">
                                        <span class="d-flex align-items-center"><i
                                                class="ti ti-calendar me-1 fs-5"></i> 19 May 2023</span>
                                        <div class="ms-auto">
                                            <a href="javascript:void(0)" class="link text-muted"><i
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h3 class="fs-6">26%</h3>
                                            <h6 class="card-subtitle mb-2 text-muted text-muted">Total Product</h6>
                                        </div>
                                        <div class="col-12">
                                            <div class="progress text-bg-light">
                                                <div class="progress-bar text-bg-success" role="progressbar"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h3 class="fs-6">60%</h3>
                                            <h6 class="card-subtitle mb-2 text-muted text-muted">Pending Product</h6>
                                        </div>
                                        <div class="col-12">
                                            <div class="progress text-bg-light">
                                                <div class="progress-bar text-bg-info" role="progressbar"
                            ...
                            <div class="card">
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12">
                                            <h3 class="fs-6">63%</h3>
                                            <h6 class="card-subtitle mb-2 text-muted text-muted">Selling Products</h6>
                                        </div>
                                        <div class="col-12">
                                            <div class="progress text-bg-light">
                                                <div class="progress-bar text-bg-danger" role="progressbar"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <img class="card-img-top" src="../assets/images/backgrounds/weather.jpg"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="card text-white">
                                <img class="card-img" src="../assets/images/backgrounds/weatherbg.jpg"
                                    alt="Card image">
                                <div class="card-img-overlay text-white">
                                    ...
                                    <div class="mt-2 mb-2">
                                        <h5 class="mb-0 text-white">WEDNESDAY</h5>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item flex-column">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        ...
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 0.08
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                                        <p class=""><i class="ti ti-arrow-down fs-5"></i>
                                                            -1.06</p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -20.10
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item flex-column">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 2.08
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                                    ...
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -21.01
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item flex-column active">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 0.12
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item flex-column">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 0.18
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                                    ...
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -0.10
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item flex-column">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 1.08
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                                    ...
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -1.01
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item flex-column active">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 2.16
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                ...
                                <div class="card-body">
                                    <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item flex-column">
                                                <div class="d-flex no-block align-items-center me-3">
                                                    <i class="ti ti-currency-ethereum display-6 text-white me-3"></i>
                                                    <div class="mt-2">
                                                        <h5 class="text-white ">
                                                            Ethereum
                                                        </h5>
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 1.18
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                            ...
                                            <div class="carousel-item flex-column active">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 1.02
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                                    ...
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -10.00
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item flex-column">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    ...
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -1.10
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item flex-column">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 2.18
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                                    ...
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -2.01
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item flex-column active">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    ...
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -1s.08
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="carousel-inner">
                                            <div class="carousel-item flex-column">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    ...
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -0.20
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="carousel-item flex-column active">
                                                ...
                                                <div class="row text-center text-white mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 1.16
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item flex-column">
                                                ...
                                                <div class="row text-center text-dark mt-4">
                                                    ...
                                                    <div class="col-4">
                                                        <span class="fs-3">% 7d</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> -1.11
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="carousel-item flex-column active">
                                                ...
                                                <div class="row text-center text-dark mt-4">
                                                    <div class="col-4">
                                                        <span class="fs-3">% 1h</span>
                                                        <p class=""><i class="ti ti-arrow-up fs-5"></i> 12.16
                                                        </p>
                                                    </div>
                                                    <div class="col-4">
                                                        <span class="fs-3">% 24h</span>
                        ...
                        <div class="col-sm-12 col-md-6">
                            <div class="card text-bg-primary">
                                <div class="card-body text-white">
                                    <div class="d-flex flex-row align-items-center">
                                        <div
                                            class="round-40 rounded-circle d-flex align-items-center justify-content-center bg-info-subtle text-primary">
                                            <i class="ti ti-credit-card fs-6"></i>
                                        </div>
                                        <div class="ms-3">
