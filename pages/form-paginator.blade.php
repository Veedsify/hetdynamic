...
<head>
    ...
    <link rel="stylesheet" href="../assets/libs/bootstrap-datepaginator/dist/bootstrap-datepaginator.min.css">
</head>
...
<body>
                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Paginator</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Paginator</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <p class="card-subtitle">
                                        A jQuery plugin which takes Twitter Bootstrap's already
                                        great pagination component and injects a bit of date based
                                        magic. In the process creating a hugely simplified and
                                        modularised way of paging date based results in your
                                        application.
                                    </p>
                                    <h4 class="card-title mt-5">Default:</h4>
                                    <div id="paginator1"></div>
                                    <h4 class="card-title mt-5">Large:</h4>
                                    <div id="paginator2"></div>
                                    <h4 class="card-title mt-5">Small:</h4>
                                    <div id="paginator3"></div>
                                    <h4 class="card-title mt-5">Onselect:</h4>
    ...
    <script src="../assets/libs/bootstrap-datepaginator/dist/bootstrap-datepaginator.min.js"></script>
    <script src="../assets/js/plugins/paginator-init.js"></script>
</body>
