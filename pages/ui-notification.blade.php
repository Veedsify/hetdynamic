                    ...
                    <div class="row">
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Default Alert</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <div class="alert bg-dark-subtle text-white alert-dismissible fade show mb-0"
                                        role="alert">
                                        <button type="button" class="btn-close btn-close-white"
                                            data-bs-dismiss="alert" aria-label="Close"></button>
                                        <strong>Dark - </strong> A simple dark alert
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <div class="alert customize-alert alert-dismissible text-primary border border-primary fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                    ...
                                    <div class="alert customize-alert alert-dismissible border-secondary text-secondary fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <div class="alert customize-alert alert-dismissible text-secondary alert-light-secondary bg-secondary-subtle fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                                    ...
                                    <div class="alert customize-alert alert-dismissible alert-light-info bg-info-subtle text-info fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Outline Rounded Alerts</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Add a dismiss button and the
                                    ...
                                    <div class="alert customize-alert alert-dismissible rounded-pill text-primary border border-primary fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                                    ...
                                    <div class="alert customize-alert alert-dismissible rounded-pill border-secondary text-secondary fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                                    ...
                                    <div class="alert customize-alert alert-dismissible rounded-pill border-success text-success fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                                    ...
                                    <div class="alert customize-alert alert-dismissible rounded-pill border-warning text-warning fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                                    ...
                                    <div class="alert customize-alert alert-dismissible rounded-pill border-info text-info fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-2">
                                        <h5 class="mb-0">Light Rounded Alerts</h5>
                                    </div>
                                    <p class="mb-3 card-subtitle">
                                        Add a dismiss button and the
                                        <mark><code>.alert-light-{ color }</code></mark> class,
                                    ...
                                    <div class="alert customize-alert alert-dismissible text-primary rounded-pill alert-light-primary bg-primary-subtle fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                                    ...
                                    <div class="alert customize-alert alert-dismissible text-secondary rounded-pill alert-light-secondary bg-secondary-subtle fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                                    ...
                                    <div class="alert customize-alert alert-dismissible text-success rounded-pill alert-light-success bg-success-subtle text-success fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                                    ...
                                    <div class="alert customize-alert alert-dismissible rounded-pill alert-light-warning bg-warning-subtle text-warning fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                                    ...
                                    <div class="alert customize-alert alert-dismissible rounded-pill alert-light-info bg-info-subtle text-info fade show remove-close-icon"
                                        role="alert">
                                        <button type="button" class="btn-close" data-bs-dismiss="alert"
                                            aria-label="Close"></button>
                                        <div class="d-flex align-items-center  me-3 me-md-0">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <div class="alert customize-alert alert-dismissible text-primary alert-light-primary bg-primary-subtle fade show remove-close-icon"
                                        role="alert">
                                        ...
                                        <div class="d-flex align-items-center ">
                                            ...
                                            <div class="ms-auto d-flex justify-content-end">
                                                <a href="javascript:void(0)" class="px-2 btn"
                                    ...
                                    <div class="alert customize-alert alert-dismissible text-warning alert-light-warning bg-warning-subtle fade show remove-close-icon"
                                        role="alert">
                                    ...
                                    <div class="alert customize-alert alert-dismissible text-info alert-light-info bg-info-subtle fade show remove-close-icon"
                                        role="alert">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    ...
                                    <div class="alert alert-light-success bg-success-subtle bg-success-subtle text-success"
                                        role="alert">
                                    ...
                                    <div class="alert alert-light-danger bg-danger-subtle bg-danger-subtle text-danger"
                                        role="alert">
