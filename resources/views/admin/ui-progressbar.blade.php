                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Progress Bars</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Default Progress bars</h5>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar text-bg-danger" style="width: 60%; height: 6px"
                        ...
                        <div class="col-md-4 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Label Progress bars</h5>
                                    </div>
                                    <div class="progress" style="height: 10px">
                                        <div class="progress-bar text-bg-success" style="width: 75%"
                                            role="progressbar">
                                            75%
                                        </div>
                                    </div>
                        ...
                        <div class="col-md-4 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Multiple Progress bar</h5>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar text-bg-danger" role="progressbar"
                                            style="width: 15%" aria-valuenow="15" aria-valuemin="0"
                                            aria-valuemax="100"></div>
                                        <div class="progress-bar text-bg-cyan" role="progressbar"
                        ...
                        <div class="col-md-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Colored Progress</h5>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar text-bg-danger" style="width: 60%; height: 6px"
                                            role="progressbar"></div>
                                    ...
                                    <div class="progress mt-4">
                                        <div class="progress-bar text-bg-info" style="width: 40%; height: 6px"
                                            role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4">
                                        <div class="progress-bar text-bg-success" style="width: 20%; height: 6px"
                                            role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4">
                                        <div class="progress-bar text-bg-primary" style="width: 30%; height: 6px"
                                            role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4">
                                        <div class="progress-bar text-bg-warning" style="width: 80%; height: 6px"
                                            role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4">
                                        <div class="progress-bar text-bg-inverse" style="width: 40%; height: 6px"
                                            role="progressbar"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Different Height Progress</h5>
                                    </div>
                                    <div class="progress" style="height: 15px">
                                        <div class="progress-bar text-bg-danger" style="width: 60%"
                                            role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4" style="height: 15px">
                                        <div class="progress-bar text-bg-info" style="width: 40%"
                                            role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4" style="height: 15px">
                                        <div class="progress-bar text-bg-success" style="width: 20%"
                                            role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4" style="height: 15px">
                                    ...
                                    <div class="progress mt-4" style="height: 15px">
                                        <div class="progress-bar text-bg-warning" style="width: 80%"
                                            role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4" style="height: 15px">
                                        <div class="progress-bar text-bg-inverse" style="width: 40%"
                                            role="progressbar"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Striped Progress</h5>
                                    </div>
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-striped text-bg-danger"
                                            style="width: 60%; height: 6px" role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4">
                                        <div class="progress-bar progress-bar-striped text-bg-info"
                                            style="width: 40%; height: 6px" role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4">
                                        <div class="progress-bar progress-bar-striped text-bg-success"
                                            style="width: 20%; height: 6px" role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4">
                                        <div class="progress-bar progress-bar-striped text-bg-primary"
                                            style="width: 30%; height: 6px" role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4">
                                        <div class="progress-bar progress-bar-striped text-bg-warning"
                                            style="width: 80%; height: 6px" role="progressbar"></div>
                                    </div>
                                    <div class="progress mt-4">
                                        <div class="progress-bar progress-bar-striped text-bg-inverse"
                                            style="width: 40%; height: 6px" role="progressbar"></div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Animated Progress</h5>
                                    </div>
                                    <div class="progress">
                                    ...
                                    <div class="progress mt-4">
                                        <div class="progress-bar progress-bar-striped text-bg-dark progress-bar-animated"
