...
<head>
    ...
    <link rel="stylesheet" href="../assets/libs/%40claviska/jquery-minicolors/jquery.minicolors.css">
</head>
                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Colorpicker</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Colorpicker</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <br>
                                        <input type="text" id="inline" class="form-control demo"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="position-bottom-left">bottom left
                                                    (default)</label>
                                        ...
                                        <div class="col-lg-6 col-sm-12">
                                            <div class="mb-3">
                                                <label class="form-label" for="position-bottom-right">bottom
                                                    right</label>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="rgb" class="form-control demo"
                                                    data-format="rgb" value="rgb(33, 147, 58)">
                                            </div>
                                        </div>
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="rgba" class="form-control demo"
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="opacity" class="form-control demo"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="input-group">
                                                    <input type="text" id="input-group"
                                                        class="form-control demo" value="#ff0000">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="more-input-group">More Input
                                                    Groups</label>
                                                <p class="card-subtitle mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    ...
                                                    <input type="text" id="more-input-group"
                                                        class="form-control demo" value="#ff0000">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="letter-case">Swatches and
                                                    opacity</label>
                                                <p class="card-subtitle mb-3">
