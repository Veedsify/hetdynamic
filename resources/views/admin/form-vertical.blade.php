                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="mb-4">
                                        <label for="exampleInputtext1"
                                            class="form-label fw-semibold">Company</label>
                                    ...
                                    <div class="mb-4">
                                        <label for="exampleInputtext2" class="form-label fw-semibold">Phone
                                            No</label>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="mb-4">
                                                <label for="exampleInputfirstname4"
                                                    class="form-label fw-semibold">First Name</label>
                                                <input type="text" class="form-control"
                                                    id="exampleInputfirstname4" placeholder="John">
                                            </div>
                                            <div class="mb-4">
                                            ...
                                            <div class="mb-4">
                                                <label for="exampleInputBirthDate"
                                                    class="form-label fw-semibold">Birth Date</label>
                                                <input id="exampleInputBirthDate" class="form-control"
                                                    type="date">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="mb-4">
                                                ...
                                                <input type="text" class="form-control"
                                                    id="exampleInputlastname" placeholder="Deo">
                                            </div>
                                            <div class="mb-4">
                                            ...
                                            <div class="mb-4">
                                                <label for="exampleInputphoneno"
                                                    class="form-label fw-semibold">Phone no</label>
                                                <input type="text" class="form-control"
                                                    id="exampleInputphoneno" placeholder="123 4567 201">
                                            </div>
                                        </div>
                                        <div class="col-12">
                        ...
                        <div class="accordion accordion-flush position-relative overflow-hidden"
                            ...
                            <div class="accordion-item mb-3 shadow-none border rounded-top">
                                <h2 class="accordion-header" id="flush-headingOne">
                                    <button
                                        class="accordion-button collapsed fs-4 fw-semibold px-3 py-6 lh-base border-0 rounded-top"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputfirstname"
                                                        class="form-label fw-semibold">First Name</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputfirstname" placeholder="John">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputphoneno3"
                                                        class="form-label fw-semibold">Phone no</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputphoneno3" placeholder="1340 2154 123">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="mb-4">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputpincode"
                                                        class="form-label fw-semibold">Pincode</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputpincode" placeholder="120125">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputlandmark"
                                                        class="form-label fw-semibold">Landmark</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputlandmark" placeholder="Nr. Wall Street">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    ...
                                                    <input type="text" class="form-control"
                                                        id="exampleInputcity" placeholder="Jackson">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                        ...
                                        <div>
                                            ...
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    name="inlineRadioOptions" id="inlineRadioHome"
                                                    value="option1">
                                                <label class="form-check-label" for="inlineRadioHome">Home (All day
                                                    delivery)</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    name="inlineRadioOptions" id="inlineRadioOffice"
                                                    value="option1">
                                                <label class="form-check-label" for="inlineRadioOffice"> Office
                                                    (Delivery between 10 AM - 5
                                                    PM)</label>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="accordion-item mb-3 shadow-none border">
                                ...
                                <div id="flush-collapseTwo" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body px-3 fw-normal">
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                name="inlineRadioOptions" id="inlineRadioStandard"
                                                value="option1">
                                            <label class="form-check-label" for="inlineRadioStandard">Standard 3-5
                                                Days</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                name="inlineRadioOptions" id="inlineRadioExpress" value="option1">
                                            <label class="form-check-label" for="inlineRadioExpress">Express</label>
                                        </div>
                                        <div class="form-check form-check-inline">
                                            <input class="form-check-input" type="radio"
                                                name="inlineRadioOptions" id="inlineRadioOvernight"
                                                value="option1">
                                            <label class="form-check-label"
                                                for="inlineRadioOvernight">Overnight</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div id="flush-collapseThree" class="accordion-collapse collapse"
                                    ...
                                    <div class="accordion-body px-3 fw-normal">
                                        <div class="mb-4">
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    name="inlineRadioOptions" id="inlineRadioCreditDebitATMCard"
                                                    value="option1">
                                                <label class="form-check-label"
                                                    for="inlineRadioCreditDebitATMCard">Credit/Debit/ATM
                                                    Card</label>
                                            </div>
                                            <div class="form-check form-check-inline">
                                                <input class="form-check-input" type="radio"
                                                    name="inlineRadioOptions" id="inlineRadioCashonDelivery"
                                                    value="option1">
                                                <label class="form-check-label" for="inlineRadioCashonDelivery">Cash
                                                    on Delivery</label>
                                            </div>
                                        </div>
                                        <div class="row">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="mb-4">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                id="exampleInputname2" placeholder="John Deo">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="mb-4">
                                                            <label for="exampleInputexpdate"
                                                                class="form-label fw-semibold">Exp. Date</label>
                                                            <input type="text" class="form-control"
                                                                id="exampleInputexpdate" placeholder="MM/YY">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-3">
                                                        <div class="mb-4">
                                                            <label for="exampleInputtext1"
                                                                class="form-label fw-semibold">CCV Code</label>
                                                            <div class="input-group">
                                                                <input type="text" class="form-control"
                                                                    placeholder="456">
                                                                <span class="input-group-text px-6"
                            ...
                            <ul class="nav nav-pills user-profile-tab border-bottom" id="pills-tab"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        ...
                                        aria-controls="pills-social-links" aria-selected="false">
                                        Social Links
                                    </button>
                                </li>
                            </ul>
                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    <div class="tab-pane fade show active" id="pills-personal-info"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputfirstname2"
                                                        class="form-label fw-semibold">First Name</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputfirstname2" placeholder="John">
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label fw-semibold">Country</label>
                                                    <select class="form-select" aria-label="Default select example">
                                                ...
                                                <div class="mb-4">
                                                    <label for="exampleInputfirstname3"
                                                        class="form-label fw-semibold">First Name</label>
                                                    <input id="exampleInputfirstname3" class="form-control"
                                                        type="date">
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputlastname2"
                                                        class="form-label fw-semibold">Last Name</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputlastname2" placeholder="Deo">
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label fw-semibold">Language</label>
                                                    <select class="form-select" aria-label="Default select example">
                                                ...
                                                <div class="mb-4">
                                                    <label for="exampleInputphoneno2"
                                                        class="form-label fw-semibold">Phone no</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputphoneno2" placeholder="123 4567 201">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-flex align-items-center gap-3">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputUsername"
                                                        class="form-label fw-semibold">Username</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputUsername" placeholder="John Deo">
                                                </div>
                                                <div class="mb-4">
                                                    <label class="form-label fw-semibold">Password</label>
                                                    <div class="input-group">
                                    ...
                                    <div class="tab-pane fade" id="pills-social-links" role="tabpanel"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputtwitter"
                                                        class="form-label fw-semibold">Twitter</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputtwitter"
                                                        placeholder="https://twitter.com/abc">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="exampleInputgoogle"
                                                        class="form-label fw-semibold">Google</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputgoogle"
                                                        placeholder="https://plus.google.com/abc">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="exampleInputinstagram"
                                                        class="form-label fw-semibold">Instagram</label>
                                                    <input type="text" class="form-control"
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-4">
                                                    <label for="exampleInputfacebook"
                                                        class="form-label fw-semibold">Facebook</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputfacebook"
                                                        placeholder="https://facebook.com/abc">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="exampleInputlinkedin"
                                                        class="form-label fw-semibold">Linkedin</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputlinkedin"
                                                        placeholder="https://linkedin.com/abc">
                                                </div>
                                                <div class="mb-4">
                                                    <label for="exampleInputquora"
                                                        class="form-label fw-semibold">Quora</label>
                                                    <input type="text" class="form-control"
                                                        id="exampleInputquora" placeholder="https://quora.com/abc">
                                                </div>
                                            </div>
                                            <div class="col-12">
                                                <div class="d-flex align-items-center gap-3">
