                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Badges</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Badges</h5>
                                    </div>
                                    <h1>
                                        Example heading
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Badges with button</h5>
                                    </div>
                                    <h6>Right Align Badge</h6>
                                    <div class="row gap-2">
                                        <div class="col-md-5">
                                            <button type="button"
                                                class="btn d-flex bg-primary-subtle w-100 d-block text-primary ">
                                                Primary
                                        ...
                                        <div class="col-md-5">
                                            <button type="button"
                                                class="btn d-flex bg-info-subtle w-100 d-block text-info ">
                                                Info <span class="badge ms-auto text-bg-info">2</span>
                                            </button>
                                        </div>
                                        <div class="col-md-5">
                                            <button type="button"
                                                class="btn d-flex bg-warning-subtle w-100 d-block text-warning ">
                                                Warning
                                        ...
                                        <div class="col-md-5">
                                            <button type="button"
                                                class="btn d-flex bg-danger-subtle w-100 d-block text-danger ">
                                                Danger <span class="badge ms-auto text-bg-danger">4</span>
                                            </button>
                                        </div>
                                        <div class="col-md-5">
                                            <button type="button"
                                                class="btn d-flex bg-success-subtle w-100 d-block text-success ">
                                                Success
                                        ...
                                        <div class="col-md-5">
                                            <button type="button"
                                                class="btn d-flex bg-secondary-subtle w-100 d-block text-secondary ">
                                                Secondary
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0 card-title">Badges with Background</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-4">
                                        <h5 class="mb-0">Badges Pill with Background</h5>
                                    </div>
                                    <h6>With Solid Background</h6>
                                    ...
                                    <h6 class="mt-3 pt-3 mt-4">With Light Background</h6>
                                    <span
                                        class="mb-1 badge rounded-pill  bg-primary-subtle text-primary">Primary</span>
                                    <span
                                        class="mb-1 badge rounded-pill  bg-secondary-subtle text-secondary">Secondary</span>
                                    <span
                                        class="mb-1 badge rounded-pill  bg-success-subtle text-success">Success</span>
                                    <span class="mb-1 badge rounded-pill  bg-danger-subtle text-danger">Danger</span>
                                    <span
                                        class="mb-1 badge rounded-pill  bg-warning-subtle text-warning">Warning</span>
