                ...
                <div class="container-fluid">
                    ...
                    <div class="card overflow-hidden">
                        <div class="card-body p-0">
                            <img src="../assets/images/backgrounds/profilebg.jpg" alt=""
                                class="img-fluid">
                            <div class="row align-items-center">
                            ...
                            <ul class="nav nav-pills user-profile-tab justify-content-end mt-2 bg-primary-subtle rounded-2 rounded-top-0"
                                ...
                                <li class="nav-item" role="presentation">
                                    <button
                                        class="nav-link position-relative rounded-0 d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"
                                        id="pills-gallery-tab" data-bs-toggle="pill"
                    ...
                    <div class="tab-content" id="pills-tabContent">
                                ...
                                <div class="col-lg-4">
                                    <div class="card shadow-none border">
                                        <div class="card-body">
                                            ...
                                            <p>Hello, I am Mathew Anderson. I love making websites and graphics. Lorem
                                                ipsum dolor sit amet,
                                                consectetur adipiscing elit.</p>
                                            <ul class="list-unstyled mb-0">
                                                <li class="d-flex align-items-center gap-6 flex-wrap mb-4">
                                                    <i class="ti ti-briefcase text-dark fs-6"></i>
                                                    <h6 class="fs-4 fw-semibold mb-0">Sir, P P Institute Of Science
                                                    </h6>
                                                </li>
                                                <li class="d-flex align-items-center gap-6 flex-wrap mb-4">
                                    ...
                                    <div class="card">
                                        <div class="card-body border-bottom">
                                            ...
                                            <img src="../assets/images/products/s1.jpg" alt=""
                                                height="360" class="rounded-4 w-100 object-fit-cover">
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mt-3 mb-4">
                                ...
                                <form class="position-relative">
                                    <input type="text" class="form-control search-chat py-2 ps-5"
                                        id="text-srh" placeholder="Search Followers">
                                    <i
                                    ...
                                    <div class="card">
                                        <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                                            ...
                                            <div>
                                                ...
                                                <span class="fs-2 d-flex align-items-center"><i
                                                        class="ti ti-map-pin text-dark fs-3 me-1"></i>United
                                                    States</span>
                                            </div>
                                            <button class="btn btn-primary py-1 px-2 ms-auto">Followed</button>
                                        </div>
                                    ...
                                    <div class="card">
                                        <div class="card-body p-4 d-flex align-items-center gap-6 flex-wrap">
                                            ...
                                            <div>
                                                ...
                                                <span class="fs-2 d-flex align-items-center"><i
                                                        class="ti ti-map-pin text-dark fs-3 me-1"></i>South
                                                    Africa</span>
                                            </div>
                                            <button class="btn btn-primary py-1 px-2 ms-auto">Followed</button>
                                        </div>
                        ...
                        <div class="tab-pane fade" id="pills-friends" role="tabpanel"
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between mt-3 mb-4">
                                ...
                                <form class="position-relative">
                                    <input type="text" class="form-control search-chat py-2 ps-5"
                                        id="text-srh" placeholder="Search Friends">
                                    <i
                                        class="ti ti-search position-absolute top-50 start-0 translate-middle-y text-dark ms-3"></i>
                                </form>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 col-lg-4">
                                    <div class="card hover-img overflow-hidden rounded-2">
                                        <div class="card-body p-0">
                                            <img src="../assets/images/products/s1.jpg" alt=""
                                                height="220" class="w-100 object-fit-cover">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu overflow-hidden">
                                                        <li><a class="dropdown-item"
                                                                href="javascript:void(0)">Isuava wakceajo fe.jpg</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-4 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu overflow-hidden">
                                                        <li><a class="dropdown-item" href="javascript:void(0)">Fu
                                                                netbuv oggu.jpg</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-4 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu overflow-hidden">
                                                        <li><a class="dropdown-item" href="javascript:void(0)">Di
                                                                sekog do.jpg</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-4 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu overflow-hidden">
                                                        <li><a class="dropdown-item" href="javascript:void(0)">Lo
                                                                jogu camhiisi.jpg</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-4 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu overflow-hidden">
                                                        <li><a class="dropdown-item"
                                                                href="javascript:void(0)">Orewac huosazud
                                                                robuf.jpg</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-4 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu overflow-hidden">
                                                        <li><a class="dropdown-item" href="javascript:void(0)">Peri
                                                                metu ejvu.jpg</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card hover-img overflow-hidden rounded-2">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-4 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <h6 class="fw-semibold mb-0 fs-4">Vurnohot tajraje isusufuj.jpg
                                                    </h6>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu overflow-hidden">
                                                        <li><a class="dropdown-item"
                                                                href="javascript:void(0)">Vurnohot tajraje
                                                                isusufuj.jpg</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                        ...
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-4 d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu overflow-hidden">
                                                        <li><a class="dropdown-item" href="javascript:void(0)">Juc
                                                                oz ma.jpg</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                ...
                                <div class="col-md-6 col-lg-4">
                                    <div class="card hover-img overflow-hidden rounded-2">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="p-4 d-flex align-items-center justify-content-between">
                                                <div>
                                                    <h6 class="fw-semibold mb-0 fs-4">Povipvez marjelliz zuuva.jpg
                                                    </h6>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu overflow-hidden">
                                                        <li><a class="dropdown-item"
                                                                href="javascript:void(0)">Povipvez marjelliz
                                                                zuuva.jpg</a></li>
                                                    </ul>
                                                </div>
                                            </div>
