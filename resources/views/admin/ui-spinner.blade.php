                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Spinner</h4>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Placement Flex</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Spinner Colors</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Loading with Text</h5>
                                    </div>
                                    <div class="d-flex align-items-center">
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h4 class="card-title mb-0">Custom Style</h4>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Spinner with Buttons</h5>
                                    </div>
                        ...
                        <div class="col-lg-6 d-flex align-items-stretch">
                            ...
                            <div class="card w-100">
                                <div class="card-body">
                                    <div class="mb-3">
                                        <h5 class="mb-0">Growing Spinner with Buttons</h5>
                                    </div>
                                    <button class="btn btn-primary" type="button" disabled="">
