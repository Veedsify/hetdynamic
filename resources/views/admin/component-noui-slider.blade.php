                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="mb-3 mt-2">
                                            <div id="success-color-slider" class="circle-filled slider-success">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <fieldset class="mt-3">
                                        <label>Extra Large Size</label>
                                        <div class="mb-3 mt-2">
                                            <div class="circle-filled slider-xl" id="circle-extra-large-slider">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        <label>Large Size</label>
                                        <div class="mb-3 mt-2">
                                            <div class="circle-filled slider-lg slider-success"
                                                id="circle-large-slider"></div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        <label>Default</label>
                                    ...
                                    <fieldset>
                                        <label>Small Size</label>
                                        <div class="mb-3 mt-2">
                                            <div class="circle-filled slider-sm slider-warning"
                                                id="circle-small-slider"></div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        <label>Extra Small</label>
                                        <div class="mb-3 mt-2">
                                            <div class="circle-filled slider-xs slider-danger"
                                                id="circle-extra-small-slider"></div>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <fieldset>
                                        <label>Large Size</label>
                                        <div class="mb-3 mt-2">
                                            <div class="square slider-lg slider-success" id="square-large-slider">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                    ...
                                    <fieldset>
                                        <label>Small Size</label>
                                        <div class="mb-3 mt-2">
                                            <div class="square slider-sm slider-warning" id="square-small-slider">
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset>
                                        <label>Extra Small</label>
                                        <div class="mb-3 mt-2">
                                            <div class="square slider-xs slider-danger"
                                                id="square-extra-small-slider"></div>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <fieldset class="mt-3">
                                        <div class="form-group text-center">
                                            ...
                                            <div id="slider-direction-top-bottom-2"
                                                class="ms-5 me-4 slider-warning"></div>
                                            <div id="slider-direction-top-bottom-3" class="ms-5 slider-danger">
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <fieldset class="mt-3">
                                        <div class="form-group text-center">
                                            ...
                                            <div id="slider-direction-bottom-top-2" class="ms-5 me-4 slider-info">
                                            </div>
                                            <div id="slider-direction-bottom-top-3" class="ms-5 slider-success">
                                            </div>
                                        </div>
                                    </fieldset>
                                </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <fieldset class="mt-3">
                                        <div class="form-group text-center">
                                            ...
                                            <div id="vert-circle-large-slider"
                                                class="circle-filled ms-3 slider-info"></div>
                                            <div id="vert-circle-default-slider"
                                                class="circle-filled ms-3 slider-success"></div>
                                            <div id="vert-circle-small-slider"
                                                class="circle-filled ms-3 slider-warning"></div>
                                            <div id="vert-circle-extra-small-slider"
                                                class="circle-filled ms-3 slider-danger"></div>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <fieldset class="mt-3">
                                        <div class="form-group text-center">
                                            ...
                                            <div id="vert-square-large-slider" class="square ms-3 slider-info">
                                            </div>
                                            <div id="vert-square-default-slider" class="square ms-3 slider-success">
                                            </div>
                                            <div id="vert-square-small-slider" class="square ms-3 slider-warning">
                                            </div>
                                            <div id="vert-square-extra-small-slider"
                                                class="square ms-3 slider-danger"></div>
                                        </div>
                                    </fieldset>
                                </div>
                            </div>
