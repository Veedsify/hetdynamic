                    ...
                    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                        <div class="card-body px-4 py-3">
                            <div class="row align-items-center">
                                <div class="col-9">
                                    <h4 class="fw-semibold mb-8">Row Separator</h4>
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            ...
                                            <li class="breadcrumb-item" aria-current="page">Row Separator</li>
                                        </ol>
                                    </nav>
                                </div>
                                <div class="col-3">
                                    ...
                                    <div class="form-group p-3 mb-3">
                                        <div class="row">
                                            <label for="inputEmail3"
                                                class="col-sm-3 text-end control-label col-form-label">First
                                                Name</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="form-group mb-3 p-3 pt-0">
                                        <div class="row">
                                            <label for="inputText1"
                                                class="col-sm-3 text-end control-label col-form-label">Last
                                                Name</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="form-group p-3 pt-0">
                                        <div class="row">
                                            <label for="inputText2"
                                                class="col-sm-3 text-end control-label col-form-label">Contact
                                                No</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="form-group p-3 text-bg-light">
                                        <div class="row">
                                            <label for="inputSelect1"
                                                class="col-sm-3 text-end control-label col-form-label">Interested
                                                In</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="form-group p-3 text-bg-light">
                                        <div class="row">
                                            <label for="inputSelect2"
                                                class="col-sm-3 text-end control-label col-form-label">Budget</label>
                                            <div class="col-sm-9">
                                    ...
                                    <div class="form-group p-3 text-bg-light">
                                        <div class="row mb-3">
                                            <label for="inputText3"
                                                class="col-sm-3 text-end control-label col-form-label">About
                                                Project</label>
                                            <div class="col-sm-9">
                                                ...
                                                <div class="form-group mb-3 row pt-3">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="email" class="form-control"
                                                            id="inputEmail6" placeholder="Username Here">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-lg-6">
                                                <div class="form-group mb-3 row pt-3">
                                                    <label for="inputText6"
                                                        class="col-sm-3 text-end control-label col-form-label">Nick
                                                        Name</label>
                                                    <div class="col-sm-9">
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-lg-6">
                                                <div class="form-group mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input type="email" class="form-control"
                                                            id="inputEmail7" placeholder="Email Here">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-sm-12 col-lg-6">
                                            ...
                                            <div class="col-sm-12 col-lg-6">
                                                <div class="form-group mb-3 row pt-3">
                                                    <label for="inputText9"
                                                        class="col-sm-3 text-end control-label col-form-label">Bio</label>
                                                    <div class="col-sm-9">
                            ...
                            <div class="card">
                                ...
                                <form class="form-horizontal r-separator">
                                    <div>
                                        <div class="form-group mb-3 p-3">
                                            <div class="row">
                                                <label for="inputText10"
                                                    class="col-sm-3 text-end control-label col-form-label">Employee
                                                    Name</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="form-group mb-3 p-3 pt-0">
                                            <div class="row">
                                                <label for="inputText11"
                                                    class="col-sm-3 text-end control-label col-form-label">Project
                                                    Name</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="form-group mb-3 p-3 pt-0">
                                            <div class="row">
                                                <label for="inputText12"
                                                    class="col-sm-3 text-end control-label col-form-label">Rate Per
                                                    Hour</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="form-group mb-3 p-3 pt-0">
                                            <div class="row">
                                                <label for="inputtime2"
                                                    class="col-sm-3 text-end control-label col-form-label">Start
                                                    Time</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="form-group mb-3 p-3 pt-0">
                                            <div class="row">
                                                <label for="inputtime3"
                                                    class="col-sm-3 text-end control-label col-form-label">End
                                                    Time</label>
                                                <div class="col-sm-9">
                                                    <input type="time" class="form-control" id="inputtime3"
                                        ...
                                        <div class="form-group mb-3 p-3 pt-0">
                                            <div class="row">
                                                <label for="inputText13"
                                                    class="col-sm-3 text-end control-label col-form-label">Notes</label>
                                                <div class="col-sm-9">
                                ...
                                <form class="form-horizontal r-separator border-top">
                                    <div>
                                        <div class="form-group mb-3 p-3">
                                            <div class="row">
                                                <label for="inputText14"
                                                    class="col-sm-3 text-end control-label col-form-label">Full
                                                    Name</label>
                                                <div class="col-sm-9">
                                        ...
                                        <div class="form-group mb-3 p-3 pt-0">
                                            <div class="row">
                                                <label for="inputEmail3"
                                                    class="col-sm-3 text-end control-label col-form-label">Existing
                                                    Customer</label>
                                                <div class="col-sm-9">
