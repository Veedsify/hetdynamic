                                        ...
                                        <div class="col-md-4 mb-4 mb-md-0">
                                            ...
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    id="chk-ignore-case">
                                                <label class="form-check-label" for="chk-ignore-case">Ignore
                                                    Case</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    id="chk-exact-match">
                                                <label class="form-check-label" for="chk-exact-match">Exact
                                                    Match</label>
                                            </div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input"
                                                    id="chk-reveal-results">
                                                <label class="form-check-label" for="chk-reveal-results">Reveal
                                                    Results</label>
                                            </div>
                                            <div class="hstack gap-6">
                                                ...
                                                <button type="button" class="btn bg-danger-subtle text-danger mt-3"
                                                    id="btn-clear-search">
                                                    Clear
                                                </button>
                                            </div>
